...
const lesson17Items = [
  ...
  {lesson:"Lesson 17",topic:"Prices & Value",english:"discount",vi:"sự giảm giá, khoản giảm giá (danh từ); (động từ) coi nhẹ, bỏ qua, không tính đến",example:"Students get a ten percent discount on all tickets.",exampleVi:"Sinh viên được giảm giá mười phần trăm cho tất cả các vé.",approx:"IPA (noun): /ˈdɪskaʊnt/ | gần đúng: DISS-kownt — IPA (verb): /dɪsˈkaʊnt/ | gần đúng: dis-KOWNT",explain:"As a noun (stress on the first syllable), an amount taken off the normal price: 'a 20% discount', 'at a discount', 'a discount code'. As a verb (stress moves to the second syllable), it means to decide that something is not important or not true: 'The police discounted the theory' (Cảnh sát đã bỏ qua giả thuyết đó). This stress shift works exactly like 'reject' in Lesson 16.",usage:"Native use: the noun is everywhere in shopping; the verb is common in news, research, and formal argument.",visual:"🔖"},
...
grammarNotesBank["Lesson 17"] = [
  ...
  {title:"Stress shift: discount, refund, and friends",body:"A group of English words changes stress depending on whether it is a noun or a verb: the noun is stressed on the FIRST syllable, the verb on the SECOND. This lesson has 'discount' and 'refund'; Lesson 16 had 'reject'. Getting the stress wrong makes the word hard for native listeners to place.",pattern:"a DIScount (n) / to disCOUNT (v) | a REfund (n) / to reFUND (v) | a REject (n) / to reJECT (v)",example:"The shop refused to reFUND my money, so I never got the REfund they promised.",meaning:"Cửa hàng từ chối hoàn lại tiền cho tôi, nên tôi không bao giờ nhận được khoản hoàn tiền mà họ đã hứa."},
