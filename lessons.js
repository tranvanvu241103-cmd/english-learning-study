...
const lesson16Items = [
  {lesson:"Lesson 16",topic:"Degree, Rules & Judgment",english:"hardly",vi:"hầu như không, khó mà",example:"I hardly know him; we've only met once.",exampleVi:"Tôi hầu như không biết anh ấy; chúng tôi chỉ gặp nhau một lần.",approx:"IPA: /ˈhɑːrdli/ | gần đúng: HAHRD-lee",explain:"An adverb meaning 'almost not' or 'barely'. It already carries negative meaning, so it is not combined with 'not'.",usage:"Native use: very common with 'hardly ever', 'hardly any', and 'can hardly' to express near-impossibility.",visual:"🙅"},
  {lesson:"Lesson 16",topic:"Degree, Rules & Judgment",english:"compulsory",vi:"bắt buộc",example:"Wearing a helmet is compulsory for all motorbike riders.",exampleVi:"Đội mũ bảo hiểm là bắt buộc đối với tất cả người đi xe máy.",approx:"IPA: /kəmˈpʌlsəri/ | gần đúng: kəm-PUL-sə-ree",explain:"Required by law or rule, with no choice involved. The formal opposite of 'optional'.",usage:"Native use: common in education, law, and workplace policy contexts.",visual:"📋"},
  {lesson:"Lesson 16",topic:"Degree, Rules & Judgment",english:"partial",vi:"một phần / thiên vị",example:"The report gave only a partial picture of what really happened.",exampleVi:"Bản báo cáo chỉ cho thấy một phần của những gì thực sự xảy ra.",approx:"IPA: /ˈpɑːrʃəl/ | gần đúng: PAHR-shəl",explain:"Usually means incomplete or not full (a partial answer); can also mean biased, favouring one side (a partial judge).",usage:"Native use: common in reports, reviews, and formal discussion of fairness.",visual:"🌗"},
  {lesson:"Lesson 16",topic:"Degree, Rules & Judgment",english:"reject",vi:"từ chối, bác bỏ",example:"The committee rejected his proposal because it was too expensive.",exampleVi:"Ủy ban đã bác bỏ đề xuất của anh ấy vì nó quá tốn kém.",approx:"IPA: /rɪˈdʒekt/ | gần đúng: ri-JEKT",explain:"To refuse to accept, believe, or agree to something; stronger than 'decline'.",usage:"Native use: common with applications, ideas, offers, and job interviews.",visual:"🚫"},
  {lesson:"Lesson 16",topic:"Degree, Rules & Judgment",english:"indicate",vi:"chỉ ra, cho thấy",example:"The data indicates a steady rise in online shopping.",exampleVi:"Dữ liệu cho thấy một sự gia tăng đều đặn trong mua sắm trực tuyến.",approx:"IPA: /ˈɪndɪkeɪt/ | gần đúng: IN-di-kayt",explain:"To show or point to something, often used with evidence, data, signs, or signals rather than direct statements.",usage:"Native use: common in reports, research, and formal writing.",visual:"👉"},

  {lesson:"Lesson 16",topic:"Events, Introductions & Health",english:"occur",vi:"xảy ra",example:"The accident occurred late at night when the roads were empty.",exampleVi:"Tai nạn xảy ra vào đêm khuya khi đường vắng.",approx:"IPA: /əˈkɜːr/ | gần đúng: ə-KUR",explain:"A formal word for 'happen'. Also used in 'it occurred to me' meaning a thought suddenly came to mind.",usage:"Native use: common in news reports, formal writing, and academic English.",visual:"⚡"},
  {lesson:"Lesson 16",topic:"Events, Introductions & Health",english:"introduce",vi:"giới thiệu",example:"The teacher introduced a new topic before starting the lesson.",exampleVi:"Giáo viên giới thiệu một chủ đề mới trước khi bắt đầu bài học.",approx:"IPA: /ˌɪntrəˈduːs/ | gần đúng: in-trə-DOOSS",explain:"To present someone or something for the first time, whether a person, an idea, or a new product or policy.",usage:"Native use: common in meetings, education, and business or product launches.",visual:"🤝"},
  {lesson:"Lesson 16",topic:"Events, Introductions & Health",english:"contents",vi:"nội dung, mục lục",example:"Please check the contents of the box before signing for delivery.",exampleVi:"Vui lòng kiểm tra nội dung bên trong hộp trước khi ký nhận.",approx:"IPA: /ˈkɑːntents/ | gần đúng: KAHN-tents",explain:"What is inside something such as a box or document, or the list of sections in a book (table of contents).",usage:"Native use: common on packaging, in books, and in formal documents.",visual:"📦"},
  {lesson:"Lesson 16",topic:"Events, Introductions & Health",english:"tropical",vi:"(thuộc) nhiệt đới",example:"They spent their honeymoon on a tropical island with warm weather all year.",exampleVi:"Họ đã đi hưởng tuần trăng mật trên một hòn đảo nhiệt đới có thời tiết ấm quanh năm.",approx:"IPA: /ˈtrɑːpɪkəl/ | gần đúng: TRAH-pi-kəl",explain:"Relating to the hot, humid regions near the equator; often used for climate, fruit, and disease.",usage:"Native use: common in travel, geography, and weather contexts.",visual:"🏝️"},
  {lesson:"Lesson 16",topic:"Events, Introductions & Health",english:"illness",vi:"bệnh tật, ốm đau",example:"A long illness kept her away from work for three months.",exampleVi:"Một trận bệnh dài khiến cô ấy phải nghỉ làm ba tháng.",approx:"IPA: /ˈɪlnəs/ | gần đúng: ILL-nəs",explain:"The general state of being sick; more formal and abstract than 'sickness', often used for serious or long conditions.",usage:"Native use: common in health, workplace, and news contexts (e.g. 'mental illness').",visual:"🤒"},

  {lesson:"Lesson 16",topic:"Character & Reputation",english:"jealously",vi:"một cách ghen tị / chặt chẽ",example:"He guarded his notebook jealously, refusing to let anyone borrow it.",exampleVi:"Anh ấy giữ cuốn sổ tay của mình một cách rất chặt chẽ, không cho ai mượn.",approx:"IPA: /ˈdʒeləsli/ | gần đúng: JEL-əs-lee",explain:"Adverb from 'jealous'; can describe envy toward someone else's success, or protecting something very possessively.",usage:"Native use: common in stories and formal writing about rivalry or possessiveness.",visual:"😒"},
  {lesson:"Lesson 16",topic:"Character & Reputation",english:"charm",vi:"sự duyên dáng / làm say mê",example:"Despite the language barrier, his charm won everyone over.",exampleVi:"Dù có rào cản ngôn ngữ, sự duyên dáng của anh ấy đã chinh phục mọi người.",approx:"IPA: /tʃɑːrm/ | gần đúng: CHAHRM",explain:"A pleasant, attractive quality that makes people like someone; as a verb, to please or attract someone strongly.",usage:"Native use: common describing personality, places, and persuasive behaviour.",visual:"✨"},
  {lesson:"Lesson 16",topic:"Character & Reputation",english:"bug",vi:"côn trùng / lỗi phần mềm",example:"The developers fixed the bug that crashed the app on startup.",exampleVi:"Các nhà phát triển đã sửa lỗi khiến ứng dụng bị treo khi khởi động.",approx:"IPA: /bʌɡ/ | gần đúng: BUG",explain:"Informally, any small insect; in technology, an error or flaw in software. Can also mean a minor illness ('a stomach bug').",usage:"Native use: very common in tech talk, casual talk about small illnesses, and everyday speech.",visual:"🐛"},
  {lesson:"Lesson 16",topic:"Character & Reputation",english:"defeat",vi:"đánh bại, thất bại",example:"The team suffered a heavy defeat in the final match.",exampleVi:"Đội đã chịu một thất bại nặng nề trong trận chung kết.",approx:"IPA: /dɪˈfiːt/ | gần đúng: di-FEET",explain:"As a noun, a loss in a competition or war; as a verb, to beat or overcome an opponent.",usage:"Native use: common in sports, politics, and formal reports of competition.",visual:"🏳️"},
  {lesson:"Lesson 16",topic:"Character & Reputation",english:"disgrace",vi:"sự ô nhục, điều đáng hổ thẹn",example:"Losing the company's funds through carelessness was a disgrace.",exampleVi:"Việc làm mất quỹ công ty do bất cẩn là một điều đáng hổ thẹn.",approx:"IPA: /dɪsˈɡreɪs/ | gần đúng: dis-GRAYSS",explain:"A situation or action that causes loss of respect or brings shame; often used to criticize public behaviour.",usage:"Native use: common in news, formal criticism, and moral judgments.",visual:"😔"},

  {lesson:"Lesson 16",topic:"Business, Media & Everyday Words",english:"off",vi:"tắt, nghỉ, giảm giá (tùy ngữ cảnh)",example:"She took the day off to rest after a long week.",exampleVi:"Cô ấy nghỉ một ngày để thư giãn sau một tuần dài.",approx:"IPA: /ɔːf/ | gần đúng: AWF",explain:"A small but flexible word: can mean not working or cancelled (a day off, the meeting is off), switched off (turn the light off), or a price reduction (10% off).",usage:"Native use: extremely common in daily conversation; meaning depends heavily on context.",visual:"🔌"},
  {lesson:"Lesson 16",topic:"Business, Media & Everyday Words",english:"media",vi:"truyền thông",example:"Social media has changed the way news spreads around the world.",exampleVi:"Mạng xã hội đã thay đổi cách tin tức lan truyền khắp thế giới.",approx:"IPA: /ˈmiːdiə/ | gần đúng: MEE-dee-ə",explain:"The organizations and channels (TV, newspapers, internet) that deliver news and information to the public.",usage:"Native use: extremely common in news, politics, and everyday discussion of the internet.",visual:"📰"},
  {lesson:"Lesson 16",topic:"Business, Media & Everyday Words",english:"roll",vi:"lăn, cuộn / bánh mì cuộn",example:"The ball rolled off the table and under the sofa.",exampleVi:"Quả bóng lăn khỏi bàn và vào gầm ghế sofa.",approx:"IPA: /roʊl/ | gần đúng: ROHL",explain:"As a verb, to move by turning over and over; as a noun, a small round piece of bread or a rolled-up item (a roll of paper).",usage:"Native use: common in daily descriptions of movement, food, and packaging.",visual:"🎳"},
  {lesson:"Lesson 16",topic:"Business, Media & Everyday Words",english:"earnings",vi:"thu nhập, tiền kiếm được",example:"The company's earnings grew by 15% this quarter.",exampleVi:"Thu nhập của công ty tăng 15% trong quý này.",approx:"IPA: /ˈɜːrnɪŋz/ | gần đúng: UR-ningz",explain:"Money earned from work or business, often used for personal income or a company's profit reports.",usage:"Native use: common in business news, finance, and salary discussions.",visual:"💰"},
  {lesson:"Lesson 16",topic:"Business, Media & Everyday Words",english:"board",vi:"hội đồng quản trị / tấm ván",example:"The board of directors approved the new budget yesterday.",exampleVi:"Hội đồng quản trị đã phê duyệt ngân sách mới vào hôm qua.",approx:"IPA: /bɔːrd/ | gần đúng: BAWRD",explain:"A group of people who manage or make decisions for a company or organization; also a flat piece of wood, or the act of getting on a plane or bus (to board a flight).",usage:"Native use: common in business meetings and travel contexts.",visual:"🧑‍💼"},
  {lesson:"Lesson 16",topic:"Business, Media & Everyday Words",english:"trade",vi:"thương mại / trao đổi",example:"The two countries signed a new trade agreement last month.",exampleVi:"Hai nước đã ký một hiệp định thương mại mới vào tháng trước.",approx:"IPA: /treɪd/ | gần đúng: TRAYD",explain:"The buying and selling of goods, especially between countries; as a verb, it can also mean to exchange one thing for another.",usage:"Native use: common in economics, business news, and everyday talk about exchanging items.",visual:"🚢"}
];
