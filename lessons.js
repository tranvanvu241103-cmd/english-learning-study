...
lessonInfo["Lesson 18"] = {
  title: "Technology and the Internet",
  level: "B2",
  goal: "Talk about devices, online life, privacy and artificial intelligence precisely, and describe how technology fails, spreads information, and changes work.",
  output: "Describe a technology that changed your daily life (an app, a device, or a service) using at least six target words from this lesson.",
  topics: ["Devices & Connectivity", "Online Life & Social Media", "Privacy & Security", "AI & The Future"]
};

const lesson18Items = [
  {lesson:"Lesson 18",topic:"Devices & Connectivity",english:"gadget",vi:"thiết bị nhỏ tiện lợi, món đồ công nghệ nhỏ gọn; (hàm ý vui) đồ chơi công nghệ, thứ hay ho nhưng không thật cần",example:"His kitchen is full of gadgets he never uses.",exampleVi:"Nhà bếp của anh ấy đầy những thiết bị nhỏ mà anh ấy chẳng bao giờ dùng đến.",approx:"IPA: /ˈɡædʒɪt/ | gần đúng: GAJ-it (âm đầu là G cứng như trong 'go', không phải 'j')",explain:"A small, clever device that does one particular job, usually electronic. It is slightly informal and often carries a hint of fun or of something unnecessary (hàm ý đồ chơi, không thật sự cần thiết), so it is not a neutral synonym for 'device'. Common collocations: the latest gadget, a handy little gadget, a kitchen gadget, a gadget lover.",usage:"Native use: very common in product reviews, tech blogs, and casual talk about presents.",visual:"🔌"},
  {lesson:"Lesson 18",topic:"Devices & Connectivity",english:"wireless",vi:"không dây; (danh từ, kiểu cũ ở Anh) máy thu thanh, cái radio",example:"The office runs on a wireless network, so there are no cables under the desks.",exampleVi:"Văn phòng chạy trên mạng không dây, nên không có sợi cáp nào dưới bàn làm việc.",approx:"IPA: /ˈwaɪərləs/ | gần đúng: WAI-ər-ləss (nhấn âm đầu)",explain:"Working without connecting wires: a wireless network, wireless headphones, wireless charging. In older British English 'the wireless' is a noun meaning the radio, which you still meet in novels and in speech from older generations (nghĩa cũ: cái radio). Note that Wi-Fi is only one particular wireless technology, so the two words are not interchangeable.",usage:"Native use: standard in any talk about home internet, headphones, and office setups.",visual:"📶"},
  {lesson:"Lesson 18",topic:"Devices & Connectivity",english:"upgrade",vi:"sự nâng cấp (danh từ); nâng cấp, cải tiến (động từ); được đổi lên hạng cao hơn (vé máy bay, phòng khách sạn)",example:"We upgraded the office computers before the new software arrived.",exampleVi:"Chúng tôi đã nâng cấp máy tính văn phòng trước khi phần mềm mới về.",approx:"IPA (noun): /ˈʌpɡreɪd/ | gần đúng: UP-grayd — IPA (verb): /ˌʌpˈɡreɪd/ | gần đúng: up-GRAYD",explain:"To make something better, more powerful, or more modern — or the improvement itself. Like 'refund' in Lesson 17, the noun is stressed on the first syllable and the verb on the second, though the difference is small in fast speech. Beyond technology it is very common in travel: 'We were upgraded to business class' (Chúng tôi được đổi lên hạng thương gia). The opposite is 'to downgrade'.",usage:"Native use: everywhere in tech, and extremely common at airports and hotel desks.",visual:"⬆️"},
  {lesson:"Lesson 18",topic:"Devices & Connectivity",english:"glitch",vi:"trục trặc nhỏ, lỗi vặt nhất thời; (động từ) bị giật, bị lỗi hình ảnh",example:"A glitch in the payment system delayed hundreds of orders.",exampleVi:"Một trục trặc trong hệ thống thanh toán đã làm chậm hàng trăm đơn hàng.",approx:"IPA: /ɡlɪtʃ/ | gần đúng: GLICH (G cứng, kết thúc bằng âm 'ch' như trong 'church')",explain:"A small, sudden fault that usually fixes itself or is repaired quickly. Compare it with 'bug' (Lesson 16): a bug is a mistake written into the program, while a glitch is a brief failure in how a system behaves (bug là lỗi nằm trong mã nguồn, glitch là trục trặc nhất thời). Common collocations: a technical glitch, a software glitch, a glitch in the system.",usage:"Native use: very common in news about banks, airlines, and websites when something briefly stops working.",visual:"⚡"},
  {lesson:"Lesson 18",topic:"Devices & Connectivity",english:"obsolete",vi:"lỗi thời, không còn dùng được nữa (vì đã có thứ tốt hơn thay thế)",example:"Fax machines became obsolete once email spread.",exampleVi:"Máy fax đã trở nên lỗi thời khi email lan rộng.",approx:"IPA (Mỹ): /ˌɑːbsəˈliːt/ | gần đúng: ah-bsə-LEET (nhấn âm cuối) — IPA (Anh): /ˈɒbsəliːt/ | gần đúng: OB-sə-leet (nhấn âm đầu)",explain:"No longer used or useful because something better has replaced it. It is stronger and more final than 'old-fashioned', which is only about style (obsolete = không dùng được nữa; old-fashioned = chỉ lỗi mốt). Common collocations: to become obsolete, to render something obsolete, obsolete technology, and 'planned obsolescence' — designing products so that they stop working after a few years.",usage:"Native use: common in technology journalism and in debates about jobs and automation.",visual:"🕰️"},
  {lesson:"Lesson 18",topic:"Online Life & Social Media",english:"browse",vi:"lướt web, xem lướt trên mạng; xem hàng mà chưa định mua; (browser) trình duyệt",example:"I was just browsing the news when I saw her photo.",exampleVi:"Tôi chỉ đang lướt tin tức thì thấy tấm ảnh của cô ấy.",approx:"IPA: /braʊz/ | gần đúng: BRAOWZ (kết thúc bằng âm /z/, không phải /s/)",explain:"To look through something in a relaxed way, without a fixed goal. In a shop it is the polite reply when an assistant offers help: 'I am just browsing, thanks' (Tôi chỉ xem thôi). The related noun 'browser' is the program you use to open web pages, and 'browsing history' is the record of the pages you visited.",usage:"Native use: essential online, and the shop phrase 'just browsing' is heard every day.",visual:"🖱️"},
  {lesson:"Lesson 18",topic:"Online Life & Social Media",english:"post",vi:"bài đăng, đăng bài (mạng xã hội); (Anh) thư từ, bưu điện, gửi thư; vị trí công việc, chức vụ; cột, cọc",example:"Her post about the earthquake was shared thousands of times.",exampleVi:"Bài đăng của cô ấy về trận động đất đã được chia sẻ hàng nghìn lần.",approx:"IPA: /poʊst/ | gần đúng: POHST",explain:"Online, a post is a message you publish and 'to post' is to publish it. Careful — the older senses are still fully alive: in British English 'the post' is the mail ('I will post the letter this afternoon'), a 'post' can be a job or official position ('a teaching post'), and physically it is a pole (a goalpost, a lamppost). Context decides which sense is meant.",usage:"Native use: the social-media sense dominates online; the mail and job senses stay very common in British writing.",visual:"📮"},
  {lesson:"Lesson 18",topic:"Online Life & Social Media",english:"viral",vi:"lan truyền chóng mặt (trên mạng); (y học) thuộc về virus, do virus gây ra",example:"The video went viral within hours of being posted.",exampleVi:"Đoạn video đã lan truyền chóng mặt chỉ vài giờ sau khi được đăng.",approx:"IPA: /ˈvaɪrəl/ | gần đúng: VAI-rəl (âm đầu đọc là /vai/, không đọc thành 'vi-ran')",explain:"Spreading very fast from person to person, exactly the way a virus does. The fixed phrase is 'to go viral' — note that it takes 'go', not 'become' or 'be'. The original medical sense is still standard: a viral infection, viral pneumonia. Related collocations: a viral video, viral marketing.",usage:"Native use: 'go viral' is one of the most common internet phrases; the medical sense is normal at the doctor's.",visual:"🔥"},
  {lesson:"Lesson 18",topic:"Online Life & Social Media",english:"subscribe",vi:"đăng ký (kênh, dịch vụ, báo dài hạn); (subscribe to a view) tán thành, theo một quan điểm",example:"Over a million people subscribe to that cooking channel.",exampleVi:"Hơn một triệu người đã đăng ký kênh nấu ăn đó.",approx:"IPA: /səbˈskraɪb/ | gần đúng: səb-SKRAIB — danh từ subscription: /səbˈskrɪpʃən/ | gần đúng: səb-SKRIP-shən (chú ý nguyên âm đổi từ /aɪ/ sang /ɪ/)",explain:"To pay or sign up to receive something regularly — a magazine, a streaming service, a channel. It is always followed by 'to': you subscribe TO a channel, never 'subscribe a channel'. In formal English, 'to subscribe to a view' means to agree with it: 'I do not subscribe to that theory' (Tôi không tán thành giả thuyết đó). The noun is 'subscription'.",usage:"Native use: unavoidable online; the formal 'subscribe to a view' sense appears in essays and debate.",visual:"🔔"},
  {lesson:"Lesson 18",topic:"Online Life & Social Media",english:"addictive",vi:"gây nghiện; (nghĩa rộng) cuốn hút đến mức không dứt ra được",example:"Short video apps are addictive by design.",exampleVi:"Các ứng dụng video ngắn được thiết kế để gây nghiện.",approx:"IPA: /əˈdɪktɪv/ | gần đúng: ə-DIK-tiv (nhấn âm giữa)",explain:"Making people want to keep doing something and unable to stop. Keep three forms apart: 'addictive' describes the thing (a game is addictive), 'addicted' describes the person and always takes 'to' ('he is addicted to his phone'), and 'addiction' is the noun. Saying 'I am addictive' is a common and funny mistake (nói vậy nghĩa là bạn khiến người khác nghiện bạn).",usage:"Native use: very common in health writing, parenting talk, and reviews of games and apps.",visual:"🧲"},
  {lesson:"Lesson 18",topic:"Privacy & Security",english:"privacy",vi:"sự riêng tư, quyền riêng tư; sự kín đáo, không bị ai quấy rầy hay dòm ngó",example:"Many users worry about privacy when apps ask for their location.",exampleVi:"Nhiều người dùng lo lắng về quyền riêng tư khi ứng dụng hỏi vị trí của họ.",approx:"IPA (Mỹ): /ˈpraɪvəsi/ | gần đúng: PRAI-və-si — IPA (Anh): /ˈprɪvəsi/ | gần đúng: PRI-və-si (người Anh thường đọc nguyên âm đầu ngắn; cả hai cách đều đúng)",explain:"The state of being free from being watched, and the right to keep your information to yourself. Common collocations: a privacy policy, privacy settings, an invasion of privacy, data privacy. Note that only the noun splits by accent — the adjective 'private' is /ˈpraɪvət/ (PRAI-vət) in both British and American English.",usage:"Native use: central to any discussion of apps, cameras, and data laws, and also everyday ('I just want some privacy').",visual:"🔏"},
  {lesson:"Lesson 18",topic:"Privacy & Security",english:"breach",vi:"sự vi phạm (luật, hợp đồng, lòng tin); vụ rò rỉ dữ liệu, vụ xâm nhập trái phép; (động từ) chọc thủng, phá vỡ",example:"The company admitted a data breach affecting two million accounts.",exampleVi:"Công ty đã thừa nhận một vụ rò rỉ dữ liệu ảnh hưởng đến hai triệu tài khoản.",approx:"IPA: /briːtʃ/ | gần đúng: BREECH (nguyên âm dài như trong 'beach', kết thúc bằng âm 'ch')",explain:"An act of breaking a rule, an agreement, or a protective barrier. In technology, 'a data breach' or 'a security breach' is the standard term for attackers getting in. In law and business: a breach of contract, a breach of trust, to be in breach of the rules. Careful with the homophone 'breech' (part of a gun) — same sound, completely different meaning.",usage:"Native use: the standard word in news reports about hacking, and in legal and HR language.",visual:"🚨"},
  {lesson:"Lesson 18",topic:"Privacy & Security",english:"encrypt",vi:"mã hóa (biến thông tin thành mã để người khác không đọc được)",example:"Messages in this app are encrypted, so nobody else can read them.",exampleVi:"Tin nhắn trong ứng dụng này được mã hóa, nên không ai khác đọc được.",approx:"IPA: /ɪnˈkrɪpt/ | gần đúng: in-KRIPT (nhấn âm thứ hai) — danh từ encryption: /ɪnˈkrɪpʃən/ | gần đúng: in-KRIP-shən",explain:"To change information into a secret code so that only the right person can read it; the opposite is 'to decrypt'. The phrase you meet most often is 'end-to-end encryption', meaning only the sender and the receiver can read a message (mã hóa đầu cuối). Common collocations: encrypted messages, an encrypted connection, strong encryption.",usage:"Native use: standard in tech news and increasingly in ordinary talk about messaging apps.",visual:"🔒"},
  {lesson:"Lesson 18",topic:"Privacy & Security",english:"fraud",vi:"sự lừa đảo, gian lận (để chiếm tiền hoặc lợi thế); kẻ lừa đảo, đồ giả mạo",example:"Online fraud rose sharply after the new payment app launched.",exampleVi:"Nạn lừa đảo trực tuyến đã tăng mạnh sau khi ứng dụng thanh toán mới ra mắt.",approx:"IPA: /frɔːd/ | gần đúng: FRAWD — tính từ fraudulent: /ˈfrɔːdʒələnt/ | gần đúng: FRAW-jə-lənt",explain:"The crime of deceiving people to get money or an advantage — and also a person who pretends to be something they are not: 'He turned out to be a complete fraud' (Hóa ra hắn là một kẻ lừa đảo hoàn toàn). Common collocations: credit card fraud, tax fraud, to commit fraud, a fraud investigation, fraudulent transactions.",usage:"Native use: standard in bank warnings, police reports, and news; the 'fake person' sense is common in casual criticism.",visual:"🎭"},
  {lesson:"Lesson 18",topic:"Privacy & Security",english:"anonymous",vi:"ẩn danh, giấu tên, không rõ danh tính; (nói về nơi chốn) vô hồn, không có nét gì riêng",example:"The tip came from an anonymous user on a forum.",exampleVi:"Nguồn tin đến từ một người dùng ẩn danh trên một diễn đàn.",approx:"IPA: /əˈnɑːnɪməs/ | gần đúng: ə-NAH-ni-məss (nhấn âm thứ hai) — danh từ anonymity: /ˌænəˈnɪməti/ | gần đúng: a-nə-NI-mə-ti (trọng âm nhảy sang âm thứ ba)",explain:"With a name that is not known or not given. Online it describes accounts, comments, and leaks: an anonymous account, to remain anonymous, an anonymous source. There is also a mildly negative sense for places with no character: 'an anonymous hotel room' (một phòng khách sạn vô hồn). Note how the stress moves in the noun 'anonymity'.",usage:"Native use: common in journalism (an anonymous source), in online discussion, and in charity donations.",visual:"🕵️"},
  {lesson:"Lesson 18",topic:"AI & The Future",english:"algorithm",vi:"thuật toán; (cách nói thông thường) cơ chế chọn và gợi ý nội dung của mạng xã hội",example:"The algorithm decides which videos you see first.",exampleVi:"Thuật toán quyết định bạn nhìn thấy video nào trước.",approx:"IPA: /ˈælɡərɪðəm/ | gần đúng: AL-gə-ri-thəm (nhấn âm đầu; 'th' ở đây là âm rung /ð/ như trong 'this', không phải /θ/ như trong 'think')",explain:"A set of steps a computer follows to solve a problem or make a decision. In everyday speech people now say 'the algorithm' to mean whatever a platform uses to choose what you see: 'The algorithm keeps showing me cat videos.' The adjective is 'algorithmic' /ˌælɡəˈrɪðmɪk/, where the stress moves to the third syllable.",usage:"Native use: technical in computing, but the casual social-media sense is now everywhere.",visual:"🧮"},
  {lesson:"Lesson 18",topic:"AI & The Future",english:"automate",vi:"tự động hóa (làm cho công việc chạy tự động, không cần người làm)",example:"The company automated its invoice checking and cut the work by half.",exampleVi:"Công ty đã tự động hóa việc kiểm tra hóa đơn và cắt giảm được một nửa khối lượng công việc.",approx:"IPA (verb): /ˈɔːtəmeɪt/ | gần đúng: AW-tə-mayt (nhấn âm đầu) — danh từ automation: /ˌɔːtəˈmeɪʃən/ | gần đúng: aw-tə-MAY-shən (trọng âm nhảy sang âm thứ ba)",explain:"To make a machine or computer do a job that a person used to do. It takes a direct object — you automate a task, a process, a report — so 'automate to check' is wrong. Related forms: automation (the trend), automatic (adjective), automatically (adverb). Common collocations: to automate a process, fully automated, automation will replace jobs.",usage:"Native use: constant in business writing and in the jobs-and-AI debate; a favourite IELTS essay topic.",visual:"🤖"},
  {lesson:"Lesson 18",topic:"AI & The Future",english:"disruptive",vi:"gây xáo trộn, phá vỡ trật tự cũ; (trong kinh doanh, nghĩa khen) mang tính đột phá, làm thay đổi cả một ngành; (học sinh) quậy phá, gây mất trật tự",example:"Streaming was disruptive: it changed the music industry completely.",exampleVi:"Dịch vụ phát trực tuyến mang tính đột phá: nó đã thay đổi hoàn toàn ngành âm nhạc.",approx:"IPA: /dɪsˈrʌptɪv/ | gần đúng: dis-RUP-tiv (nhấn âm giữa) — động từ disrupt: /dɪsˈrʌpt/ | gần đúng: dis-RUPT",explain:"Causing something to stop working in the normal way. The tone depends completely on the field: in a classroom a disruptive child is a problem (nghĩa tiêu cực), while in business and technology 'disruptive' is high praise for a product that overturns an old industry (nghĩa tích cực). Common collocations: a disruptive technology, a disruptive start-up, disruptive behaviour.",usage:"Native use: the business sense fills technology and start-up writing; the classroom sense is standard in schools.",visual:"💥"},
  {lesson:"Lesson 18",topic:"AI & The Future",english:"misinformation",vi:"thông tin sai lệch (được lan truyền, thường không cố ý)",example:"Health misinformation spreads fastest in closed group chats.",exampleVi:"Thông tin sai lệch về sức khỏe lan nhanh nhất trong các nhóm chat kín.",approx:"IPA: /ˌmɪsɪnfərˈmeɪʃən/ | gần đúng: mis-in-fər-MAY-shən (nhấn mạnh vào âm 'MAY')",explain:"False information that gets passed around, usually because people believe it is true. Learn it beside 'disinformation', which is false information spread deliberately to deceive (misinformation: sai mà không cố ý; disinformation: cố tình bịa để đánh lừa). It is uncountable, so never 'a misinformation' and never 'misinformations' — say 'a lot of misinformation' or 'a piece of misinformation'.",usage:"Native use: very common in journalism, public health, and social-media policy — a strong IELTS and news word.",visual:"📰"},
  {lesson:"Lesson 18",topic:"AI & The Future",english:"cutting-edge",vi:"tiên tiến bậc nhất, hiện đại nhất hiện nay; (the cutting edge of) mũi nhọn, tuyến đầu của một lĩnh vực",example:"The lab works with cutting-edge medical technology.",exampleVi:"Phòng thí nghiệm này làm việc với công nghệ y tế tiên tiến bậc nhất.",approx:"IPA: /ˌkʌtɪŋ ˈedʒ/ | gần đúng: kə-ting-EJ (trọng âm rơi vào 'EDGE')",explain:"At the most advanced stage of development. Watch the hyphen: write 'cutting-edge' before a noun ('cutting-edge research') but 'the cutting edge' as a noun phrase after a verb ('Their lab is at the cutting edge of gene therapy'). 'State-of-the-art' is a close synonym, and 'obsolete' in this lesson is its opposite.",usage:"Native use: common in advertising, research writing, and job adverts — strong praise, and sometimes overused.",visual:"🚀"}
];

grammarNotesBank["Lesson 18"] = [
  {title:"Tech verbs and the prepositions they demand",body:"Several high-frequency words in this lesson only work with one preposition, and Vietnamese speakers often drop it or choose the wrong one. You subscribe TO a channel, never 'subscribe a channel'. A person is addicted TO something, while the thing itself is addictive. Videos GO viral — not 'become viral'. And a failure of rules or security is a breach OF something.",pattern:"subscribe to sth | be addicted to sth | sth is addictive | go viral | a breach of sth",example:"He is addicted to a game that went viral last year, and he has subscribed to three channels about it.",meaning:"Cậu ấy nghiện một trò chơi đã lan truyền chóng mặt hồi năm ngoái, và cậu ấy đã đăng ký ba kênh nói về trò đó."},
  {title:"The passive: how technology is described",body:"Writing about technology is full of passive verbs, because what happens to your data matters more than who does it. Form the passive with be + past participle, and add 'by' only when naming the agent is genuinely useful. This is the natural register for privacy policies, product pages, and news reports about systems.",pattern:"be + past participle (+ by sb) | Messages are encrypted. | Two million accounts were breached. | The checks have been automated.",example:"Your messages are encrypted before they are sent, and your data is never sold to advertisers.",meaning:"Tin nhắn của bạn được mã hóa trước khi được gửi đi, và dữ liệu của bạn không bao giờ bị bán cho các nhà quảng cáo."},
  {title:"Stress shift and pronunciation traps in this lesson",body:"'Upgrade' follows the same noun-verb rule as 'refund' in Lesson 17: the noun is UPgrade, the verb is upGRADE. Three other words hide traps. 'Algorithm' is stressed on the first syllable and its 'th' is the soft /ð/ of 'this', not the /θ/ of 'think'. 'Anonymous' is stressed on the second syllable, but the noun 'anonymity' pushes the stress to the third. And 'privacy' genuinely splits by accent — PRAI-vəsi in America, PRI-vəsi in Britain — while the adjective 'private' stays PRAI-vət everywhere.",pattern:"an UPgrade (n) / to upGRADE (v) | ALgorithm / algoRITHmic | aNONymous / anoNYmity | PRAIvacy (US) / PRIvacy (UK)",example:"The free upgrade was announced anonymously, but anyone can see how the algorithm changed.",meaning:"Bản nâng cấp miễn phí được công bố một cách ẩn danh, nhưng ai cũng thấy được thuật toán đã thay đổi thế nào."},
  {title:"Pairs that look alike but are not",body:"Four contrasts in this lesson are worth memorising, because using the wrong half changes your meaning. A 'bug' (Lesson 16) is a mistake in the code, while a 'glitch' is a brief failure in behaviour. 'Misinformation' spreads by accident, while 'disinformation' is spread on purpose. Something 'obsolete' can no longer be used at all, while something 'old-fashioned' is merely out of style. And 'disruptive' is high praise in business but a complaint in a classroom.",pattern:"bug vs glitch | misinformation vs disinformation | obsolete vs old-fashioned | disruptive (business, positive) vs disruptive (classroom, negative)",example:"The app has one real bug, but yesterday's crash was only a glitch, and the story blaming hackers is misinformation.",meaning:"Ứng dụng có một lỗi thật trong mã nguồn, nhưng sự cố sập hôm qua chỉ là một trục trặc nhất thời, còn bài viết đổ lỗi cho tin tặc là thông tin sai lệch."}
];

grammarBank["Lesson 18"] = [
  {q:"Choose the correct preposition: More than a million people subscribe ___ that channel.",choices:["to","for","in"],a:"to",why:"'Subscribe' is always followed by 'to'; the object never comes straight after the verb."},
  {q:"Choose the best verb: The video ___ viral within hours of being posted.",choices:["went","became","was"],a:"went",why:"The fixed phrase is 'to go viral' — native speakers do not say 'become viral'."},
  {q:"Choose the passive form: All messages ___ before they leave your phone.",choices:["are encrypted","encrypt","are encrypting"],a:"are encrypted",why:"Be + past participle. The action matters more than who performs it, so the passive is natural here."},
  {q:"Choose the right word: False information passed on by mistake, not to deceive, is ___.",choices:["misinformation","disinformation","fraud"],a:"misinformation",why:"Disinformation is deliberate and fraud is a crime for money; misinformation is simply false and repeated in good faith."}
];

listeningBank["Lesson 18"] = {
  text:"When Lan started her first job at a small news website, she thought the technology would be the easy part. Her laptop was so old that the newsroom called it obsolete, and the free upgrade she had been promised never arrived. On her second day a glitch in the publishing system deleted an entire article, and for an hour nobody could work because the wireless network kept dropping. Her editor laughed and said that in this office the gadgets were older than the interns. The real lessons, though, came from the readers. One evening a short video the team had posted went viral, and by morning it had been shared half a million times. Refreshing the page to watch the number climb was almost addictive. Lan read the comments arriving and realised that the algorithm, not the editor, had decided which story the country would talk about that day. Some of what spread alongside it was pure misinformation, repeated in good faith by people who had never checked the source, while a few anonymous accounts were clearly pushing it on purpose. Then came the difficult week. A data breach at their payment partner exposed the email addresses of everyone who subscribed to the paid newsletter, and several readers reported attempts at fraud within days. The company moved fast: it encrypted everything it stored, rewrote its privacy policy in plain English, and automated the security checks that had been done by hand. Lan wrote the apology herself. Six months later the site runs on cutting-edge software and browsing it is far faster, but Lan still keeps a note above her desk reminding her that the most disruptive thing about technology is rarely the technology itself.",
  meaning:"Khi Lan bắt đầu công việc đầu tiên tại một trang tin nhỏ, cô nghĩ công nghệ sẽ là phần dễ dàng. Chiếc laptop của cô cũ đến mức cả tòa soạn gọi nó là đồ lỗi thời, còn bản nâng cấp miễn phí mà người ta hứa thì chẳng bao giờ đến. Ngày làm việc thứ hai, một trục trặc trong hệ thống xuất bản đã xóa mất nguyên một bài viết, và suốt một tiếng đồng hồ không ai làm việc được vì mạng không dây cứ rớt liên tục. Sếp biên tập của cô cười và bảo rằng ở văn phòng này, mấy món đồ công nghệ còn già hơn cả thực tập sinh. Tuy nhiên, những bài học thật sự lại đến từ độc giả. Một buổi tối, đoạn video ngắn mà nhóm đăng lên đã lan truyền chóng mặt, và đến sáng hôm sau nó đã được chia sẻ nửa triệu lần. Việc tải lại trang để xem con số nhảy lên gần như gây nghiện. Lan đọc những bình luận đổ về và nhận ra rằng chính thuật toán, chứ không phải người biên tập, mới là thứ quyết định cả nước sẽ bàn tán về câu chuyện nào trong ngày hôm đó. Một phần những gì lan truyền kèm theo là thông tin sai lệch thuần túy, được những người chưa bao giờ kiểm chứng nguồn tin lặp lại một cách vô tình, trong khi vài tài khoản ẩn danh thì rõ ràng đang cố tình đẩy nó đi. Rồi tuần lễ khó khăn ập đến. Một vụ rò rỉ dữ liệu ở đối tác thanh toán đã làm lộ địa chỉ email của tất cả những người đã đăng ký bản tin trả phí, và chỉ vài ngày sau, nhiều độc giả báo lại rằng họ bị lừa đảo. Công ty hành động nhanh: họ mã hóa toàn bộ dữ liệu lưu trữ, viết lại chính sách quyền riêng tư bằng thứ tiếng Anh dễ hiểu, và tự động hóa các bước kiểm tra an ninh vốn trước đây phải làm thủ công. Lan tự tay viết lời xin lỗi. Sáu tháng sau, trang tin chạy trên phần mềm tiên tiến bậc nhất và việc lướt xem nhanh hơn hẳn, nhưng Lan vẫn giữ một mẩu giấy dán phía trên bàn làm việc để nhắc mình rằng thứ gây xáo trộn nhất ở công nghệ hiếm khi là bản thân công nghệ.",
  questions:[
    {q:"What two problems did Lan face on her second day at work?",a:["a glitch deleted an entire article and the wireless network kept dropping","a glitch in the publishing system deleted an article and the wireless network kept dropping"],hint:"One was a brief software fault; the other was the connection."},
    {q:"According to Lan, who or what decided which story the country would talk about?",a:["the algorithm","the algorithm, not the editor"],hint:"Not a person — a set of steps a platform follows."},
    {q:"Name two things the company did after the data breach.",a:["it encrypted everything it stored and automated the security checks","it encrypted its data, rewrote its privacy policy, and automated the security checks"],hint:"One protects stored data with a secret code; another removed work done by hand."}
  ],
  dictation:["A glitch in the publishing system deleted an entire article, and the wireless network kept dropping.","The company encrypted everything it stored and rewrote its privacy policy in plain English."]
};

quizBank["Lesson 18"] = [
  {q:"Translate: thiết bị nhỏ tiện lợi, món đồ công nghệ nhỏ gọn",a:["gadget"],hint:"Slightly informal, often with a hint of fun or of something unnecessary."},
  {q:"Complete: The office runs on a ___ network, so there are no cables under the desks.",a:["wireless"],hint:"Working without connecting wires; in old British English it also meant the radio."},
  {q:"Complete: We ___ the office computers before the new software arrived.",a:["upgraded"],hint:"To make something better or more modern. The verb is stressed on the second syllable."},
  {q:"Translate: trục trặc nhỏ, lỗi vặt nhất thời",a:["glitch"],hint:"Not a mistake in the code — a brief failure in how a system behaves."},
  {q:"Translate: lỗi thời, không còn dùng được nữa",a:["obsolete"],hint:"Stronger than old-fashioned: replaced by something better."},
  {q:"Complete: I was just ___ the news when I saw her photo.",a:["browsing"],hint:"Looking through something with no fixed goal; also what you say in a shop."},
  {q:"Translate: bài đăng (trên mạng xã hội)",a:["post"],hint:"In British English the same word also means the mail and a job position."},
  {q:"Complete: The video went ___ within hours of being posted.",a:["viral"],hint:"Spreading fast from person to person, like a virus."},
  {q:"Complete: Over a million people ___ to that cooking channel.",a:["subscribe"],hint:"To sign up to receive something regularly. It always needs 'to'."},
  {q:"Translate: gây nghiện (nói về đồ vật, ứng dụng)",a:["addictive"],hint:"Describes the thing, not the person — the person is 'addicted'."},
  {q:"Translate: sự riêng tư, quyền riêng tư",a:["privacy"],hint:"Americans say PRAI-, the British say PRI-."},
  {q:"Complete: The company admitted a data ___ affecting two million accounts.",a:["breach"],hint:"Breaking a rule, an agreement, or a protective barrier."},
  {q:"Complete: Messages in this app are ___, so nobody else can read them.",a:["encrypted"],hint:"Changed into a secret code. The opposite is decrypted."},
  {q:"Translate: sự lừa đảo, gian lận",a:["fraud"],hint:"A crime of deception; it can also mean a person who is a fake."},
  {q:"Translate: ẩn danh, giấu tên",a:["anonymous"],hint:"Stressed on the second syllable; the noun moves the stress again."},
  {q:"Complete: The ___ decides which videos you see first.",a:["algorithm"],hint:"A set of steps a computer follows. The 'th' sounds like 'this'."},
  {q:"Complete: The company ___ its invoice checking and cut the work by half.",a:["automated"],hint:"To make a computer do a job a person used to do."},
  {q:"Translate: mang tính đột phá, làm thay đổi cả một ngành",a:["disruptive"],hint:"Praise in business, but a complaint in a classroom."},
  {q:"Translate: thông tin sai lệch (lan truyền không cố ý)",a:["misinformation"],hint:"Uncountable. Its deliberate twin starts with 'dis-'."},
  {q:"Complete: The lab works with ___ medical technology.",a:["cutting-edge","cutting edge"],hint:"At the most advanced stage; the opposite of obsolete."},
  {q:"Complete the preposition: A million people subscribe ___ that newsletter.",a:["to"],hint:"Not 'for' and not 'in'."},
  {q:"Complete the pattern: Her cooking video ___ viral overnight.",a:["went"],hint:"The fixed phrase takes this verb, never 'became'."},
  {q:"Complete: False information spread deliberately to deceive is called ___.",a:["disinformation"],hint:"The intentional twin of misinformation."},
  {q:"Complete: He turned out to be a complete ___ — none of his qualifications were real.",a:["fraud"],hint:"The 'fake person' sense of a money-crime word."},
  {q:"Complete: I do not ___ to that theory at all.",a:["subscribe"],hint:"Formal sense: to agree with a view."},
  {q:"Complete: I will ___ the letter on my way to work.",a:["post"],hint:"British English sense: to send by mail."},
  {q:"Complete: We were ___ to business class without paying anything extra.",a:["upgraded"],hint:"The travel sense: moved to a higher class."},
  {q:"Complete: The room was clean but ___ — it could have been any hotel in the world.",a:["anonymous"],hint:"The 'no character at all' sense."},
  {q:"Complete: Email has rendered the fax machine almost ___.",a:["obsolete"],hint:"Made it no longer usable or needed."},
  {q:"Complete: He is ___ to his phone and checks it every few minutes.",a:["addicted"],hint:"The person form, not the thing form. It takes 'to'."}
];

lessonInfo["Lesson 19"] = {
  title: "Cooking, Kitchen Actions and Textures",
  level: "B2",
  goal: "Give and follow cooking instructions with the exact verb for each action, and describe how food and surfaces feel using precise texture adjectives.",
  output: "Explain how you cook one dish you know well, step by step, using at least six target words from this lesson and two texture adjectives.",
  topics: ["Preparing Ingredients", "Heat and Cooking Methods", "While You Cook", "Texture and Surface"]
};

const lesson19Items = [
  {lesson:"Lesson 19",topic:"Preparing Ingredients",english:"rinse",vi:"rửa qua bằng nước sạch, tráng nước, vo (gạo); xả sạch xà phòng; súc miệng",example:"Rinse the rice twice before you cook it.",exampleVi:"Hãy vo gạo hai lần trước khi bạn nấu.",approx:"IPA: /rɪns/ | gần đúng: RINS (nguyên âm ngắn như trong 'sit' — đừng kéo dài thành 'rai-ns' theo kiểu chữ viết)",explain:"To wash something quickly with clean water, usually to remove soap, dust or loose dirt rather than to clean it deeply. Keep it apart from 'wash': you wash the plates with soap, then you rinse them under the tap (wash = rửa kỹ, có xà phòng; rinse = chỉ tráng lại bằng nước). The same verb covers the dentist's instruction 'rinse your mouth' (súc miệng) and laundry: 'rinse out the cloth'. Common collocations: rinse under cold water, rinse thoroughly, rinse off the soap, the rinse cycle on a washing machine.",usage:"Native use: in every recipe, on laundry labels, and at the dentist — a very high-frequency everyday verb.",visual:"💧"},
  {lesson:"Lesson 19",topic:"Preparing Ingredients",english:"chop",vi:"cắt, chặt thành khúc/miếng bằng nhát dao mạnh; đốn (cây); (nghĩa bóng) cắt giảm mạnh (ngân sách, nhân sự)",example:"Chop the onions finely and set them aside.",exampleVi:"Cắt hành thật nhỏ rồi để riêng ra một bên.",approx:"IPA (Mỹ): /tʃɑːp/, (Anh): /tʃɒp/ | gần đúng: CHOP (bắt đầu bằng âm 'ch' như trong 'church', không phải âm 'sh')",explain:"To cut something into rough pieces with heavy downward strokes of a knife. It sits between two neighbours in this lesson: 'slice' gives you thin flat pieces, and 'mince' gives you tiny fine pieces, while 'chop' is chunkier and quicker. Phrasal uses: chop up the carrots, chop down a tree (đốn hạ), chop off a branch (chặt đứt). Figuratively, budgets and jobs 'get chopped'. As a noun, 'a pork chop' is a cut of meat with the bone in (miếng sườn). Spelling: chop → chopped, chopping (gấp đôi chữ p).",usage:"Native use: the default kitchen verb in recipes and cooking videos; also common in business talk about cuts.",visual:"🔪"},
  {lesson:"Lesson 19",topic:"Preparing Ingredients",english:"slice",vi:"thái lát mỏng; lát, miếng (một lát bánh mì, một miếng pizza); (nghĩa bóng) một phần chia được của cái gì",example:"Slice the beef as thinly as you can.",exampleVi:"Hãy thái thịt bò mỏng hết mức có thể.",approx:"IPA: /slaɪs/ | gần đúng: SLAIS (nguyên âm đôi /aɪ/, kết thúc bằng /s/ nhẹ chứ không phải /z/)",explain:"To cut something into thin flat pieces. The noun is just as common as the verb: a slice of bread, a slice of cake, two slices of ham. Figurative sense: 'a slice of the profits' means a share (một phần lợi nhuận), and 'a slice of life' is a realistic everyday scene in a film or story. Watch the fixed praise phrase 'the best thing since sliced bread' — used, often jokingly, for something wonderful.",usage:"Native use: everywhere in recipes and at food counters ('Could I have four slices, please?').",visual:"🍞"},
  {lesson:"Lesson 19",topic:"Preparing Ingredients",english:"mince",vi:"băm nhuyễn, băm nhỏ; (danh từ, Anh) thịt băm; (mince your words) nói vòng vo, nói giảm đi cho đỡ mất lòng",example:"Mince three cloves of garlic and add them to the hot oil.",exampleVi:"Băm nhuyễn ba tép tỏi rồi cho vào dầu đang nóng.",approx:"IPA: /mɪns/ | gần đúng: MINS (vần với 'rinse' — nguyên âm ngắn, chữ 'e' cuối câm)",explain:"To cut food into extremely small pieces, finer than 'chop'. It is the standard verb for garlic, ginger and herbs. Note the British/American split in the noun: in Britain 'mince' means ground meat ('a kilo of mince'), while Americans say 'ground beef' — but 'minced garlic' is normal everywhere. The idiom you will meet in news and argument is negative: 'She does not mince her words' means she says exactly what she thinks, without softening it (nói thẳng, không rào trước đón sau).",usage:"Native use: standard in recipes; the idiom 'not to mince words' is common in journalism and debate.",visual:"🧄"},
  {lesson:"Lesson 19",topic:"Preparing Ingredients",english:"crack",vi:"đập vỡ (trứng), làm nứt; vết nứt (danh từ); phá được (mật mã, vụ án); (crack a joke) kể một câu đùa; (crack up) cười phá lên hoặc suy sụp tinh thần",example:"Crack two eggs into the bowl and beat them lightly.",exampleVi:"Đập hai quả trứng vào bát rồi đánh nhẹ lên.",approx:"IPA: /kræk/ | gần đúng: KRAK (nguyên âm mở rộng như trong 'cat', không đọc thành 'krếch')",explain:"To break the shell or surface of something so that a line appears — you crack an egg, and a wall or a phone screen cracks. The noun 'a crack' is that line: 'There is a crack in the wall.' The secondary senses are all high-frequency: crack a code, crack a case (phá án), crack a password, crack a joke (kể chuyện cười), crack up (cười phá lên, hoặc suy sụp), and 'get cracking' meaning to start work immediately (bắt tay vào làm ngay). The related adjective 'cracked' describes dry heels and old paint.",usage:"Native use: constant in cooking, in news about security, and in casual conversation through its idioms.",visual:"🥚"},
  {lesson:"Lesson 19",topic:"Heat and Cooking Methods",english:"boil",vi:"đun sôi, luộc; sôi lên; (boil down to) tóm lại là, quy về; (boiling) nóng kinh khủng",example:"Boil the water before you add the noodles.",exampleVi:"Đun sôi nước trước khi bạn cho mì vào.",approx:"IPA: /bɔɪl/ | gần đúng: BOYL (nguyên âm đôi /ɔɪ/ như trong 'boy')",explain:"To heat a liquid until it bubbles hard, or to cook food in that liquid: boiled eggs, boiled potatoes. Contrast it with 'simmer' in this lesson — boiling is violent, simmering is gentle. Informally, 'boiling' means extremely hot: 'It is boiling in here.' The very useful phrasal verb 'boil down to' means to reduce to one essential point: 'It all boils down to money' (Tóm lại là chuyện tiền bạc). 'To bring something to the boil' is the fixed phrase for heating it until it boils.",usage:"Native use: the first verb in thousands of recipes; 'boil down to' is common in analysis and argument.",visual:"🫧"},
  {lesson:"Lesson 19",topic:"Heat and Cooking Methods",english:"simmer",vi:"ninh, nấu liu riu (sôi lăn tăn dưới điểm sôi); (nghĩa bóng) âm ỉ (cơn giận, mâu thuẫn); (simmer down) bình tĩnh lại",example:"Let the soup simmer for twenty minutes so the flavour develops.",exampleVi:"Cứ để súp ninh liu riu trong hai mươi phút cho ngấm vị.",approx:"IPA: /ˈsɪmər/ | gần đúng: SIM-ər (nhấn âm đầu, âm cuối nhẹ như tiếng 'ơ')",explain:"To cook gently just below boiling point, so only small bubbles rise. This is the exact word for Vietnamese 'ninh' and 'om'. The figurative sense is about emotions and conflicts that stay hot without exploding: 'Resentment had been simmering for months' (Sự bực bội đã âm ỉ suốt nhiều tháng), and 'a simmering dispute'. 'Simmer down' is an informal command meaning calm down. Note the standard recipe instruction 'bring to the boil, then reduce the heat and simmer'.",usage:"Native use: standard in cooking; the 'simmering tensions' sense is very common in news writing.",visual:"🍲"},
  {lesson:"Lesson 19",topic:"Heat and Cooking Methods",english:"fry",vi:"chiên, rán (trong dầu mỡ); (stir-fry) xào; (deep-fry) chiên ngập dầu; (small fry) kẻ tép riu, nhân vật không quan trọng",example:"Fry the eggs in a little butter over medium heat.",exampleVi:"Chiên trứng với một chút bơ trên lửa vừa.",approx:"IPA: /fraɪ/ | gần đúng: FRAI — quá khứ 'fried' /fraɪd/: FRAID; danh từ số nhiều 'fries' /fraɪz/: FRAIZ",explain:"To cook food in hot oil or fat. English splits this into a family of verbs you should learn together: 'pan-fry' and 'shallow-fry' use a little oil, 'deep-fry' covers the food in oil (chiên ngập dầu), and 'stir-fry' means to cook quickly over high heat while stirring constantly — the exact word for Vietnamese 'xào'. Spelling: the -y changes to -i (fry → fried, fries). The idiom 'small fry' means unimportant people, and 'I have bigger fish to fry' means I have more important things to do.",usage:"Native use: essential in cooking; 'stir-fry' is the word to use when describing Vietnamese and Chinese dishes in English.",visual:"🍳"},
  {lesson:"Lesson 19",topic:"Heat and Cooking Methods",english:"steam",vi:"hấp (nấu bằng hơi nước); hơi nước (danh từ); (let off steam) xả bớt căng thẳng; (run out of steam) đuối sức, hết hơi",example:"Steam the fish for eight minutes so that it stays soft.",exampleVi:"Hấp cá trong tám phút để cá vẫn mềm.",approx:"IPA: /stiːm/ | gần đúng: STEEM (nguyên âm dài /iː/, kéo hơn 'sit' rõ rệt)",explain:"To cook food over boiling water, using only the hot vapour — usually described in English as the healthiest method because nothing dissolves into the water. The noun 'steam' is the vapour itself. Three idioms are worth keeping: 'let off steam' means to release stress by shouting or exercising (xả stress), 'run out of steam' means to lose energy before finishing, and 'full steam ahead' means to move forward with total commitment.",usage:"Native use: common in recipes and health writing; the three idioms appear constantly in workplace conversation.",visual:"♨️"},
  {lesson:"Lesson 19",topic:"Heat and Cooking Methods",english:"grill",vi:"nướng (trên vỉ, lửa trực tiếp); vỉ nướng, bếp nướng (danh từ); (nghĩa bóng) tra hỏi dồn dập, chất vấn gắt",example:"We grilled the meat over charcoal in the garden.",exampleVi:"Chúng tôi nướng thịt trên than trong vườn.",approx:"IPA: /ɡrɪl/ | gần đúng: GRIL (âm G cứng như trong 'go', không phải /dʒ/)",explain:"To cook with strong direct heat and no oil. There is a real British/American difference: in America, to grill means to cook on a barbecue with the heat below, and heat from above is called 'to broil'; in Britain, 'the grill' is the part of the oven with the heat above. The figurative sense is very common in news: 'The police grilled him for hours' means they questioned him aggressively (tra hỏi gắt gao). Compare 'roast' (nướng trong lò bằng hơi nóng bao quanh) and 'bake' (nướng bánh).",usage:"Native use: everyday in cooking; the 'question aggressively' sense is standard in journalism and politics.",visual:"🔥"},
  {lesson:"Lesson 19",topic:"While You Cook",english:"stir",vi:"khuấy, đảo (bằng thìa, đũa); cựa quậy, nhúc nhích; (stir up) khuấy động, kích động; (stirring) gây xúc động mạnh",example:"Stir the soup so that it does not stick to the bottom of the pot.",exampleVi:"Khuấy súp để nó không dính đáy nồi.",approx:"IPA (Mỹ): /stɜːr/ | gần đúng: STER (âm 'er' cong lưỡi, một âm tiết duy nhất — đừng tách thành 'sờ-tia')",explain:"To move a liquid or mixture around in circles with a spoon. It also means to move slightly: 'Nobody stirred when the alarm went off.' The phrasal verb 'stir up' means to cause trouble or strong feeling deliberately: 'stir up trouble', 'stir up old memories' (khơi lại chuyện cũ). The adjective 'stirring' is positive and means emotionally moving: 'a stirring speech'. Spelling: stir → stirred, stirring (gấp đôi chữ r).",usage:"Native use: in every recipe, and 'stir up' is frequent in political and social commentary.",visual:"🥄"},
  {lesson:"Lesson 19",topic:"While You Cook",english:"flip",vi:"lật, trở mặt (thức ăn, trang sách); búng (đồng xu); (flip through) lật giở nhanh; (flip out) nổi khùng, mất bình tĩnh",example:"Flip the pancake as soon as bubbles appear on top.",exampleVi:"Lật bánh ngay khi có bong bóng nổi lên trên mặt.",approx:"IPA: /flɪp/ | gần đúng: FLIP — quá khứ 'flipped' /flɪpt/: FLIPT (đuôi -ed đọc là /t/, gấp đôi chữ p khi viết)",explain:"To turn something over quickly with one movement. It is more energetic than 'turn over', which is neutral. High-frequency uses beyond the kitchen: flip a coin (to decide something by chance), flip a switch, flip through a magazine (lật lướt qua), and the informal 'flip out', meaning to suddenly become very angry or upset. In business English, 'to flip' a house or a phone means to buy it and resell it quickly for profit.",usage:"Native use: standard in cooking and in the very common phrase 'let's flip a coin'.",visual:"🥞"},
  {lesson:"Lesson 19",topic:"While You Cook",english:"season",vi:"nêm gia vị (động từ); mùa, mùa vụ (danh từ); (in season / out of season) đúng mùa / trái mùa; (a seasoned + N) dày dạn kinh nghiệm",example:"Season the soup with salt and pepper right at the end.",exampleVi:"Nêm muối và tiêu vào súp ngay lúc cuối.",approx:"IPA: /ˈsiːzn/ | gần đúng: SEE-zən (chữ 's' đầu đọc /s/, chữ 's' giữa đọc /z/ — hai âm khác nhau trong cùng một từ)",explain:"As a verb, to add salt, pepper or herbs to food; the noun 'seasoning' means the spices themselves. Do not lose the everyday noun: 'season' is a time of year or a sports/TV season, and the pair 'in season / out of season' is used for both food and travel prices: 'Mangoes are in season now'; 'Hotels are cheaper out of season.' A third sense is very useful for describing people: 'a seasoned traveller' or 'a seasoned negotiator' means highly experienced (dày dạn kinh nghiệm).",usage:"Native use: 'season to taste' ends countless recipes; 'a seasoned professional' is common praise at work.",visual:"🧂"},
  {lesson:"Lesson 19",topic:"While You Cook",english:"taste",vi:"nếm, có vị (động từ); vị, mùi vị (danh từ); gu thẩm mỹ, sở thích; (a taste of) một lần trải nghiệm thử",example:"Taste the sauce before you add any more salt.",exampleVi:"Nếm thử nước sốt trước khi bạn cho thêm muối.",approx:"IPA: /teɪst/ | gần đúng: TAYST (nguyên âm đôi /eɪ/ — không đọc gọn thành 'tát')",explain:"To put a little food in your mouth to check it — and also to have a particular flavour. As a linking verb it must be followed by an adjective, not an adverb: 'It tastes salty', never 'tastes saltily'; and you say 'It tastes like fish' or 'It tastes of garlic'. The noun covers personal preference: 'She has good taste in music' (gu âm nhạc), and 'a taste of freedom' means a short first experience of it. Two adjectives that learners mix up: 'tasty' means delicious, while 'tasteful' means elegant and in good taste.",usage:"Native use: 'season to taste' and 'It tastes great' are daily phrases; the 'gu' sense appears in every review.",visual:"👅"},
  {lesson:"Lesson 19",topic:"While You Cook",english:"drain",vi:"chắt nước, để ráo; ống thoát nước, cống (danh từ); rút cạn, làm kiệt sức; (draining) mệt lả, hao tổn tinh thần",example:"Drain the pasta and return it to the warm pan.",exampleVi:"Chắt ráo nước mì rồi đổ lại vào nồi còn ấm.",approx:"IPA: /dreɪn/ | gần đúng: DRAYN (nguyên âm đôi /eɪ/ giống 'rain')",explain:"To let liquid run away from something — in the kitchen you drain pasta in a colander or drain a tin of beans. The noun 'a drain' is the pipe or hole that carries water away. The figurative senses are strong and very common: 'an emotionally draining week' means exhausting (vắt kiệt sức), 'a brain drain' is the loss of skilled people to other countries (chảy máu chất xám), and 'money down the drain' means money completely wasted (tiền đổ sông đổ biển).",usage:"Native use: routine in recipes; 'draining' and 'down the drain' are very frequent in everyday complaint.",visual:"🚰"},
  {lesson:"Lesson 19",topic:"Texture and Surface",english:"sticky",vi:"dính, nhớp nháp; (thời tiết) oi bức và ẩm; (tình huống) khó xử, rắc rối, gai góc",example:"The rice is too sticky because I added too much water.",exampleVi:"Cơm bị nhão dính vì tôi cho quá nhiều nước.",approx:"IPA: /ˈstɪki/ | gần đúng: STI-ki (nguyên âm ngắn, nhấn âm đầu)",explain:"Covered with a substance that clings to your fingers, like honey or glue. Two secondary senses are worth learning together with it: about weather, 'sticky' means hot and humid, which describes a Hanoi summer exactly ('a sticky August afternoon'); and about problems, 'a sticky situation' means an awkward or difficult one ('We are in a sticky situation with the landlord'). Related words: sticky rice (gạo nếp), a sticky note, to stick / stuck.",usage:"Native use: everyday in food, weather talk, and the very common phrase 'a sticky situation'.",visual:"🍯"},
  {lesson:"Lesson 19",topic:"Texture and Surface",english:"slippery",vi:"trơn trượt; (nói về người) lươn lẹo, khó tin, hay né tránh; (a slippery slope) con đường trượt dốc, bước đầu dẫn tới hậu quả xấu",example:"Wet tiles are slippery, so walk carefully in the kitchen.",exampleVi:"Gạch ướt rất trơn, nên hãy bước cẩn thận trong bếp.",approx:"IPA: /ˈslɪpəri/ | gần đúng: SLI-pə-ri (ba âm tiết, nhấn âm đầu — nhiều người bỏ mất âm giữa)",explain:"So smooth or wet that things slide on it. Describing a person, it is clearly negative: 'a slippery character' is someone dishonest who avoids straight answers (lươn lẹo). The fixed phrase 'a slippery slope' is one of the most common arguments in English: it means a first small step that leads to a much worse result ('Letting one team break the rule is a slippery slope'). Compare 'smooth', which is neutral and describes a surface with no bumps.",usage:"Native use: standard on warning signs ('Caution: slippery floor') and 'a slippery slope' is constant in debate.",visual:"🧼"},
  {lesson:"Lesson 19",topic:"Texture and Surface",english:"brittle",vi:"giòn, dễ gãy vụn (cứng nhưng gãy chứ không cong); (móng, xương) giòn dễ gãy; (giọng nói, tiếng cười) khô cứng, gượng gạo; (quan hệ) mong manh dễ vỡ",example:"Old biscuits go brittle and break the moment you pick them up.",exampleVi:"Bánh quy để lâu trở nên giòn vụn và vỡ ngay khi bạn cầm lên.",approx:"IPA: /ˈbrɪtl/ | gần đúng: BRI-təl (hai âm tiết, âm cuối nuốt gọn — không đọc rõ thành 'bri-tơn')",explain:"Hard but easily broken, because it snaps instead of bending. Do not confuse it with 'crispy' or 'crunchy', which are positive words for food that is pleasant to bite: 'brittle' stresses fragility, not enjoyment. The medical use is important and matches the picture of damaged nails: brittle nails, brittle bones (a symptom of low calcium). Figuratively, 'a brittle laugh' or 'a brittle voice' sounds tense and forced, and 'a brittle relationship' could break at any moment.",usage:"Native use: common in health writing and materials science, and in literary description of tense people.",visual:"🍪"},
  {lesson:"Lesson 19",topic:"Texture and Surface",english:"grainy",vi:"lợn cợn, sạn sạn như có hạt nhỏ; (ảnh, video) bị nhiễu hạt, mờ nhòe",example:"The sauce turned grainy because the heat was too high.",exampleVi:"Nước sốt bị lợn cợn vì lửa quá to.",approx:"IPA: /ˈɡreɪni/ | gần đúng: GRAY-ni (âm G cứng, nguyên âm đôi /eɪ/)",explain:"Feeling or looking as if it is made of small hard grains rather than being smooth. In cooking it is a fault: a grainy sauce, grainy chocolate, grainy ice cream all mean the mixture separated or the sugar did not dissolve. The second sense is about images and is extremely common in news: 'grainy CCTV footage' or 'a grainy photograph' means low quality, full of visible dots (nhiễu hạt). The related noun is 'grain' — a single small seed, or the pattern in wood.",usage:"Native use: standard in food writing for a failed texture, and in crime reporting for poor-quality video.",visual:"🥣"},
  {lesson:"Lesson 19",topic:"Texture and Surface",english:"fluffy",vi:"xốp mềm, bông xốp (cơm, bánh, khăn); mềm mượt như lông tơ; (nghĩa chê nhẹ) hời hợt, không có chiều sâu",example:"Beat the eggs until the mixture is light and fluffy.",exampleVi:"Đánh trứng cho đến khi hỗn hợp nhẹ và bông xốp.",approx:"IPA: /ˈflʌfi/ | gần đúng: FLA-fi (nguyên âm /ʌ/ như trong 'cup' — không đọc thành 'flu-fi')",explain:"Soft, light and full of air. In food it is high praise: fluffy rice, fluffy pancakes, a fluffy omelette. About objects it means soft and slightly hairy: a fluffy towel, a fluffy kitten, a fluffy blanket. There is a mild criticism sense for content and people: 'a fluffy article' is pleasant but empty of substance, and 'fluffy thinking' is vague (hời hợt, thiếu chặt chẽ). The opposite in cooking is 'dense' or 'heavy'.",usage:"Native use: constant in baking and product descriptions; the 'empty content' sense appears in reviews and criticism.",visual:"☁️"}
];

grammarNotesBank["Lesson 19"] = [
  {title:"The imperative: the grammar of every recipe",body:"Recipes and spoken instructions drop the subject completely and use the bare form of the verb: 'Chop the onions.' 'Do not overcook the fish.' Order the steps with First, Then, Next, After that, and Finally. Two patterns cause trouble for Vietnamese speakers. First, 'let' takes a bare infinitive with no 'to': 'Let the soup simmer', never 'let the soup to simmer'. Second, to say how long, use 'for + period' and to say until what point, use 'until + clause'.",pattern:"Verb + object. | Do not + verb. | Let + object + bare verb. | ... for twenty minutes | ... until the water boils",example:"Rinse the rice, then let it drain for ten minutes until the water runs clear.",meaning:"Vo gạo, rồi để cho ráo nước trong mười phút cho đến khi nước trong."},
  {title:"How finely? Adverbs and quantity phrases in the kitchen",body:"English puts the adverb of manner after the object, not between the verb and the object: 'Chop the onions finely', not 'chop finely the onions'. The most useful adverbs here are finely, thinly, roughly, gently and thoroughly. For amounts, uncountable ingredients need a measure word plus 'of': a clove of garlic, a pinch of salt, two tablespoons of oil, a bunch of herbs. Say 'a little' with uncountable nouns and 'a few' with countable ones.",pattern:"verb + object + adverb | a clove of garlic | a pinch of salt | a little oil / a few cloves",example:"Slice the beef thinly, mince a clove of garlic, and add just a little oil.",meaning:"Thái thịt bò mỏng, băm nhuyễn một tép tỏi, và chỉ cho một chút dầu."},
  {title:"Texture adjectives after linking verbs",body:"Words like sticky, brittle, grainy and fluffy follow a linking verb, and a linking verb is always followed by an adjective, never an adverb. The linking verbs you need most for texture are be, taste, feel, look, smell, go, turn and become. Remember that 'go' and 'turn' both signal a change, and 'go' usually points to a change for the worse: 'The biscuits went brittle', 'The sauce turned grainy'.",pattern:"be / taste / feel / look / go / turn + ADJECTIVE (not adverb)",example:"The rice feels sticky, the sauce has turned grainy, and the old bread has gone brittle.",meaning:"Cơm sờ thấy dính, nước sốt đã bị lợn cợn, còn bánh mì cũ thì đã giòn vụn."},
  {title:"Spelling and pronunciation traps in this lesson",body:"Three short verbs double their final consonant before -ed and -ing: chop → chopped, chopping; stir → stirred, stirring; flip → flipped, flipping. 'Fry' changes -y to -i: fried, fries. In pronunciation, keep 'rinse' and 'mince' short (/ɪ/) but 'slice' long and wide (/aɪ/), even though all three end in the same letters. In 'season' the first s is /s/ and the second is /z/. 'Stir' is one syllable with a curled 'er' sound, not two. And 'grill' starts with a hard G, like 'go'.",pattern:"chop→chopped | stir→stirred | flip→flipped | fry→fried | rinse /ɪ/ vs slice /aɪ/ | season = SEE-zən",example:"I chopped the herbs, stirred the pot, flipped the fish, and fried an egg while the rice steamed.",meaning:"Tôi đã cắt rau thơm, khuấy nồi, lật con cá, và chiên một quả trứng trong khi cơm đang hấp."}
];

grammarBank["Lesson 19"] = [
  {q:"Choose the correct form: Let the soup ___ for twenty minutes.",choices:["simmer","to simmer","simmering"],a:"simmer",why:"'Let' is followed by an object and then the bare infinitive — no 'to' and no -ing."},
  {q:"Choose the natural word order: ___",choices:["Chop the onions finely.","Chop finely the onions.","Finely chop the the onions."],a:"Chop the onions finely.",why:"In English an adverb of manner comes after the object, not between the verb and its object."},
  {q:"Choose the correct word: The sauce turned ___ because the heat was too high.",choices:["grainy","grainily","grain"],a:"grainy",why:"'Turn' is a linking verb, so it takes an adjective, never an adverb."},
  {q:"Choose the right verb: ___ the fish for eight minutes so that it stays soft and does not dry out.",choices:["Steam","Grill","Fry"],a:"Steam",why:"Only steaming cooks with vapour and keeps the fish moist; grilling and frying both use direct heat or oil."}
];

listeningBank["Lesson 19"] = {
  text:"The first time Minh cooked dinner for his host family in Manchester, he realised that he knew the food but not the words. He could see exactly what to do, yet every instruction in the English recipe used a verb he had never needed before. He rinsed the rice three times, the way his mother had taught him, and left it to drain in a sieve while he read the rest of the page. Then he chopped the onions, sliced the beef as thinly as he could, and minced two cloves of garlic. When he cracked the eggs into a bowl, one shell broke badly and he had to fish the pieces out with a spoon. The cooking itself went faster. He boiled water for the noodles, brought a small pot of broth to the boil and then reduced the heat so that it could simmer quietly at the back of the stove. He fried the eggs in a little butter, steamed the fish for eight minutes so that it stayed soft, and grilled the beef for less than a minute on each side. All the way through he kept stirring the broth, flipping the fish, and tasting everything before he seasoned it again. His host mother came in halfway through and started naming things without being asked. The rice, she said, was beautifully fluffy. The sauce had gone slightly grainy, which happens when the heat is too high, and the floor near the sink was slippery, so he should be careful. The crackers she had bought that morning were already brittle and breaking in the packet. Minh wrote every word down that evening. Six months later he could follow any recipe in English, and he had noticed something else: the words for texture were the ones he used most outside the kitchen, because sticky weather, a sticky situation and a slippery character all came up in ordinary conversation far more often than pasta ever did.",
  meaning:"Lần đầu tiên Minh nấu bữa tối cho gia đình chủ nhà ở Manchester, cậu nhận ra rằng mình biết món ăn nhưng lại không biết từ. Cậu thấy rõ mình phải làm gì, thế nhưng mọi hướng dẫn trong công thức tiếng Anh đều dùng một động từ mà cậu chưa từng cần đến. Cậu vo gạo ba lần, đúng như cách mẹ đã dạy, rồi để ráo trong cái rây trong lúc đọc nốt phần còn lại của trang giấy. Sau đó cậu cắt hành, thái thịt bò mỏng hết mức có thể, và băm nhuyễn hai tép tỏi. Khi đập trứng vào bát, một quả bị vỡ vỏ tệ hại và cậu phải dùng thìa vớt mấy mảnh vỏ ra. Phần nấu nướng thì trôi nhanh hơn. Cậu đun sôi nước để luộc mì, đun một nồi nước dùng nhỏ đến khi sôi rồi hạ lửa để nó ninh liu riu ở phía trong bếp. Cậu chiên trứng với một chút bơ, hấp cá tám phút để cá vẫn mềm, và nướng thịt bò chưa đầy một phút mỗi mặt. Suốt quá trình đó cậu liên tục khuấy nước dùng, lật cá, và nếm thử mọi thứ trước khi nêm lại. Bà chủ nhà bước vào giữa chừng và bắt đầu gọi tên từng thứ mà chẳng ai hỏi. Bà bảo cơm xốp mềm rất đẹp. Nước sốt hơi bị lợn cợn, chuyện vẫn xảy ra khi lửa quá to, còn sàn nhà gần bồn rửa thì trơn, nên cậu phải cẩn thận. Mấy cái bánh quy giòn bà mua sáng hôm đó thì đã giòn vụn và vỡ ngay trong gói. Tối hôm ấy Minh ghi lại từng từ một. Sáu tháng sau cậu có thể làm theo bất kỳ công thức tiếng Anh nào, và cậu còn nhận ra một điều nữa: những từ chỉ kết cấu mới là thứ cậu dùng nhiều nhất bên ngoài gian bếp, bởi thời tiết oi bức ẩm, một tình huống khó xử và một kẻ lươn lẹo xuất hiện trong trò chuyện thường ngày nhiều hơn hẳn so với món mì.",
  questions:[
    {q:"What did Minh do to the rice before he read the rest of the recipe?",a:["he rinsed it three times and left it to drain","he rinsed the rice three times and left it to drain in a sieve"],hint:"Two verbs: one about washing with clean water, one about letting water run off."},
    {q:"Why did the sauce go grainy, according to the host mother?",a:["the heat was too high","because the heat was too high"],hint:"It was a problem with the temperature, not the ingredients."},
    {q:"Which kind of words did Minh find most useful outside the kitchen?",a:["the words for texture","texture adjectives like sticky and slippery"],hint:"Think of sticky weather, a sticky situation, and a slippery character."}
  ],
  dictation:["He boiled water for the noodles and then reduced the heat so that the broth could simmer quietly.","The rice was beautifully fluffy, but the sauce had gone slightly grainy."]
};

quizBank["Lesson 19"] = [
  {q:"Translate: vo gạo, rửa qua bằng nước sạch",a:["rinse"],hint:"Only water, no soap — a quick wash to remove what is loose."},
  {q:"Complete: ___ the onions finely and set them aside.",a:["chop"],hint:"Heavy downward strokes of a knife, into rough pieces."},
  {q:"Complete: ___ the beef as thinly as you can.",a:["slice"],hint:"Thin flat pieces; the noun also means a piece of bread or cake."},
  {q:"Translate: băm nhuyễn (nhỏ hơn cả chop)",a:["mince"],hint:"The standard verb for garlic and ginger."},
  {q:"Complete: ___ two eggs into the bowl and beat them lightly.",a:["crack"],hint:"To break the shell so a line appears."},
  {q:"Complete: ___ the water before you add the noodles.",a:["boil"],hint:"Heat a liquid until it bubbles hard."},
  {q:"Translate: ninh, nấu liu riu dưới điểm sôi",a:["simmer"],hint:"Gentle cooking with only small bubbles."},
  {q:"Complete: ___ the eggs in a little butter over medium heat.",a:["fry"],hint:"Cook in hot oil or fat."},
  {q:"Translate: hấp (nấu bằng hơi nước)",a:["steam"],hint:"The healthiest method — nothing dissolves into the water."},
  {q:"Complete: We ___ the meat over charcoal in the garden.",a:["grilled"],hint:"Strong direct heat, no oil."},
  {q:"Complete: ___ the soup so that it does not stick to the bottom of the pot.",a:["stir"],hint:"Move a liquid in circles with a spoon."},
  {q:"Complete: ___ the pancake as soon as bubbles appear on top.",a:["flip"],hint:"Turn it over quickly with one movement."},
  {q:"Complete: ___ the soup with salt and pepper right at the end.",a:["season"],hint:"Add salt, pepper or herbs. The same word means a time of year."},
  {q:"Complete: ___ the sauce before you add any more salt.",a:["taste"],hint:"Put a little in your mouth to check it."},
  {q:"Complete: ___ the pasta and return it to the warm pan.",a:["drain"],hint:"Let the liquid run away."},
  {q:"Translate: dính, nhớp nháp",a:["sticky"],hint:"Like honey on your fingers."},
  {q:"Translate: trơn trượt",a:["slippery"],hint:"Three syllables, stress on the first."},
  {q:"Translate: giòn, dễ gãy vụn (cứng nhưng gãy chứ không cong)",a:["brittle"],hint:"Not the same as crispy — this word stresses fragility."},
  {q:"Complete: The sauce turned ___ because the heat was too high.",a:["grainy"],hint:"Feeling as if it contains small hard grains."},
  {q:"Complete: Beat the eggs until the mixture is light and ___.",a:["fluffy"],hint:"Soft, light and full of air."},
  {q:"Complete: The verb for cooking quickly over high heat while stirring constantly, the exact word for 'xào', is to ___.",a:["stir-fry","stir fry"],hint:"A compound of two verbs from this lesson."},
  {q:"Complete: It all ___ down to money in the end.",a:["boils"],hint:"The phrasal sense: to reduce to one essential point."},
  {q:"Complete: She does not ___ her words — she tells you exactly what she thinks.",a:["mince"],hint:"The idiom uses a cutting verb from this lesson."},
  {q:"Complete: Working with him for a year was emotionally ___ — I had no energy left.",a:["draining"],hint:"The figurative -ing form of a kitchen verb."},
  {q:"Complete: Let's ___ a coin to decide who goes first.",a:["flip"],hint:"The non-cooking sense of turning something over."},
  {q:"Complete: He is a ___ traveller who has been to forty countries.",a:["seasoned"],hint:"The 'highly experienced' sense of a cooking word."},
  {q:"Complete: We are in a ___ situation with the landlord and nobody knows what to do.",a:["sticky"],hint:"The 'awkward and difficult' sense of a texture word."},
  {q:"Complete: Allowing one team to break the rule is a ___ slope.",a:["slippery"],hint:"The fixed argument phrase: one small step leading to a much worse result."},
  {q:"Complete: The police released ___ CCTV footage of the suspect.",a:["grainy"],hint:"The image sense: low quality, full of visible dots."},
  {q:"Complete: The police ___ him for hours about where he had been that night.",a:["grilled"],hint:"The figurative sense of a cooking method: to question aggressively."},
  {q:"Complete: After the argument her father told everyone to ___ down.",a:["simmer"],hint:"The phrasal sense: to calm down."},
  {q:"Complete: Tensions had been ___ in the department for months before anyone spoke up.",a:["simmering"],hint:"The figurative sense: hot but not exploding."}
];

lessonInfo["Lesson 20"] = {
  title: "Skin, Everyday Verbs and Linking Time",
  level: "B2",
  goal: "Describe skin and body conditions accurately, use ten high-frequency verbs and nouns with the patterns native speakers expect, and link events in time without repeating 'and then'.",
  output: "Tell the story of a change in your life over the last two years, using at least four time linkers and six other target words from this lesson.",
  topics: ["Skin and Body Conditions", "Everyday Verbs", "Everyday Nouns and Adjectives", "Linking Time"]
};

const lesson20Items = [
  {lesson:"Lesson 20",topic:"Skin and Body Conditions",english:"chapped",vi:"nứt nẻ, khô nẻ (môi, da tay vì lạnh hoặc gió)",example:"My lips get chapped every winter no matter what I do.",exampleVi:"Môi tôi cứ đến mùa đông là nứt nẻ dù tôi có làm gì đi nữa.",approx:"IPA: /tʃæpt/ | gần đúng: CHAPT — chỉ MỘT âm tiết, đuôi -ed đọc là /t/, tuyệt đối không đọc thành 'chap-pịt'",explain:"Rough, dry and slightly split, caused by cold air or wind. In practice it collocates with only two body parts: chapped lips and chapped hands. The product for it is a 'lip balm', called 'Chapstick' in America after the brand. Note that the verb 'to chap' is rare today — you will almost always meet this word as an adjective after 'be' or 'get': 'My lips are chapped', 'My hands got chapped'.",usage:"Native use: everyday in winter, in pharmacy conversation, and on skincare packaging.",visual:"👄"},
  {lesson:"Lesson 20",topic:"Skin and Body Conditions",english:"flaky",vi:"bong tróc thành mảng vảy nhỏ (da khô, da đầu); (bánh) nhiều lớp giòn xốp; (nói về người, thân mật) không đáng tin, hay hủy kèo",example:"The skin around his nose is dry and flaky in cold weather.",exampleVi:"Vùng da quanh mũi anh ấy khô và bong vảy khi trời lạnh.",approx:"IPA: /ˈfleɪki/ | gần đúng: FLAY-ki (nguyên âm đôi /eɪ/, nhấn âm đầu)",explain:"Coming off in small thin pieces. On the body: dry, flaky skin and a flaky scalp, which is what causes gàu (dandruff). In food the same word is entirely positive: flaky pastry and a flaky croissant are made of many thin crisp layers. There is a third, informal American sense describing people: 'He is so flaky' means unreliable, someone who agrees to plans and then cancels. The related noun is 'a flake' and the verb 'to flake off'.",usage:"Native use: standard in skincare and baking; the 'unreliable person' sense is common in casual American speech.",visual:"🧴"},
  {lesson:"Lesson 20",topic:"Skin and Body Conditions",english:"cracked",vi:"nứt nẻ, rạn nứt (gót chân, tường, màn hình); (giọng) vỡ, lạc giọng; (cracked it) đã giải được, đã tìm ra cách",example:"After a summer in sandals her heels were badly cracked.",exampleVi:"Sau một mùa hè đi dép lê, gót chân cô ấy nứt nẻ nặng.",approx:"IPA: /krækt/ | gần đúng: KRAKT — MỘT âm tiết, đuôi -ed đọc là /t/; đừng đọc thành 'crack-kịt'",explain:"Having split lines running through the surface. On the body it is the standard word for dry heels and dry hands in winter, and it is stronger than 'chapped': chapped skin is rough and sore, cracked skin has actually split open. The same adjective covers a cracked wall, a cracked phone screen and a cracked plate. Two extra senses: a voice 'cracked' with emotion means it broke and lost control, and informally 'We cracked it' means we finally solved the problem. This is the adjective form of the verb 'crack' in Lesson 19.",usage:"Native use: standard in skincare, in describing damage to objects, and in the phrase 'a cracked screen'.",visual:"🦵"},
  {lesson:"Lesson 20",topic:"Skin and Body Conditions",english:"peeling",vi:"đang bong tróc từng lớp mỏng (da sau khi cháy nắng, sơn tường bong)",example:"My hand started peeling a week after the sunburn.",exampleVi:"Tay tôi bắt đầu bong da một tuần sau khi bị cháy nắng.",approx:"IPA: /ˈpiːlɪŋ/ | gần đúng: PEE-ling (nguyên âm dài /iː/, nhấn âm đầu)",explain:"Coming away from a surface in thin layers. Note the grammar difference from Lesson 13's 'peel': there you peel an apple, with an object, but here the skin peels by itself, with no object at all — 'My back is peeling.' The same intransitive use covers paint and wallpaper: 'The paint is peeling off the wall.' The phrasal verb 'peel off' also means to leave a group or to remove clothing quickly. Compare 'flaky' in this lesson: flaky pieces are small and dry, peeling comes away in sheets.",usage:"Native use: standard after sunburn, and very common in describing old buildings and rented rooms.",visual:"🩹"},
  {lesson:"Lesson 20",topic:"Skin and Body Conditions",english:"callus",vi:"vết chai, cục da chai sần (ở chân, tay do cọ xát nhiều); (calloused) chai sạn — cả nghĩa đen và nghĩa bóng là vô cảm",example:"The runner had a hard callus on the ball of his foot.",exampleVi:"Người chạy bộ có một cục chai cứng ở phần gan bàn chân trước.",approx:"IPA: /ˈkæləs/ | gần đúng: KA-ləs (nhấn âm đầu) — đọc y hệt từ 'callous', chỉ khác chính tả",explain:"A thick, hard patch of skin formed by repeated rubbing — on a guitarist's fingertips, a runner's foot, a worker's palm. The spelling trap is worth memorising: 'callus' with -us is the lump (a noun), while 'callous' with -ous is an adjective meaning cruel and unfeeling ('a callous remark' = một lời nói nhẫn tâm). They sound identical. The adjective 'calloused' can be literal praise for hard work ('calloused hands') or figurative for someone who has stopped caring.",usage:"Native use: common in sport, music and medical talk; 'callous' is a strong word in news and criticism.",visual:"🦶"},
  {lesson:"Lesson 20",topic:"Everyday Verbs",english:"register",vi:"đăng ký (khóa học, tài khoản, cư trú); ghi nhận, thể hiện (cảm xúc); nhận ra, thấm vào đầu; sổ đăng ký (danh từ); (ngôn ngữ) văn phong, mức độ trang trọng",example:"You have to register for the exam before the end of the month.",exampleVi:"Bạn phải đăng ký thi trước cuối tháng.",approx:"IPA: /ˈredʒɪstər/ | gần đúng: RE-jis-tər (nhấn âm ĐẦU; chữ 'g' đọc là /dʒ/ như trong 'gym')",explain:"To put your name on an official list. Watch the prepositions: you register FOR a course or an exam, register WITH a doctor or an agency, and register AS a member. Compare the neighbours: 'sign up' is the informal everyday equivalent, and 'enrol' is used for courses and schools. The other senses are all worth knowing: 'His name did not register' means I did not recognise it (không thấm vào đầu); 'Her face registered surprise'; 'the cash register' is the till in a shop; and in language study, 'formal register' means the level of formality you choose.",usage:"Native use: unavoidable in admin, study and travel; the 'it did not register' sense is very common in speech.",visual:"📝"},
  {lesson:"Lesson 20",topic:"Everyday Verbs",english:"suggest",vi:"đề xuất, gợi ý; ám chỉ, cho thấy (bằng chứng, số liệu)",example:"I suggest that we leave an hour earlier to avoid the traffic.",exampleVi:"Tôi đề xuất chúng ta khởi hành sớm hơn một tiếng để tránh tắc đường.",approx:"IPA: /səˈdʒest/ | gần đúng: sə-JEST (nhấn âm THỨ HAI; âm đầu rất nhẹ — đừng đọc thành 'sấc-gét')",explain:"To put forward an idea for other people to consider. This word carries the single most common grammar mistake Vietnamese learners make with it: 'suggest' never takes an object plus a to-infinitive. Say 'I suggest going early', 'I suggest that you go early', or 'I suggest you go early' — but never 'I suggest you to go'. The second sense is essential in academic writing: evidence, data and results 'suggest' something, meaning they indicate it without proving it. The noun is 'suggestion': 'Can I make a suggestion?'",usage:"Native use: constant in meetings and emails, and the 'the data suggests' pattern fills academic and IELTS writing.",visual:"💡"},
  {lesson:"Lesson 20",topic:"Everyday Verbs",english:"produce",vi:"sản xuất, tạo ra; đưa ra, trình ra (giấy tờ, bằng chứng); sản xuất phim, nhạc; (danh từ, nhấn âm đầu) nông sản tươi, rau quả",example:"The factory produces two thousand bottles an hour.",exampleVi:"Nhà máy sản xuất hai nghìn chai mỗi giờ.",approx:"IPA (động từ): /prəˈduːs/ | gần đúng: prə-DOOS — IPA (danh từ): /ˈproʊduːs/ | gần đúng: PROH-doos. Trọng âm đổi thì NGHĨA cũng đổi hẳn.",explain:"To make or grow something. It follows the same stress-shift rule as 'refund' in Lesson 17 and 'upgrade' in Lesson 18, but here the noun means something completely different: 'fresh produce' is fruit and vegetables, and 'the produce section' is that part of a supermarket. Other live senses: 'Please produce your ID' means show it; a film is 'produced by' someone. Keep the family straight — the abstract noun for the factory sense is 'production', the person is 'a producer', and 'a product' is the thing itself.",usage:"Native use: everywhere in business and news; the 'fresh produce' noun is standard in shops and recipes.",visual:"🏭"},
  {lesson:"Lesson 20",topic:"Everyday Verbs",english:"consume",vi:"tiêu thụ, dùng hết (điện, nhiên liệu, thời gian); ăn hoặc uống (cách nói trang trọng); thiêu rụi, nuốt chửng; (be consumed with) bị dằn vặt, ám ảnh",example:"Older air conditioners consume far more electricity than new ones.",exampleVi:"Máy điều hòa đời cũ tiêu thụ điện nhiều hơn hẳn so với máy mới.",approx:"IPA: /kənˈsuːm/ | gần đúng: kən-SOOM (nhấn âm hai) — danh từ 'consumption': /kənˈsʌmpʃən/ | gần đúng: kən-SUMP-shən (nguyên âm đổi từ /uː/ sang /ʌ/)",explain:"To use something up, especially a resource. It is also the formal word for eating and drinking, which is why you see it on packaging: 'Consume within three days of opening.' The family matters: 'a consumer' is a customer as an economic actor (người tiêu dùng), 'consumption' is the amount used, and 'time-consuming' means it takes a lot of time. Two figurative senses are strong: 'Fire consumed the whole building', and 'She was consumed with guilt' (bị cảm giác tội lỗi dằn vặt).",usage:"Native use: standard in energy, economics and health writing; 'time-consuming' is common in ordinary work talk.",visual:"🔋"},
  {lesson:"Lesson 20",topic:"Everyday Verbs",english:"demand",vi:"đòi hỏi, yêu cầu gay gắt (động từ); nhu cầu (kinh tế); (in demand) được săn đón; (demanding) đòi hỏi cao, vất vả",example:"The job demands a lot of patience and very careful attention.",exampleVi:"Công việc này đòi hỏi rất nhiều kiên nhẫn và sự chú ý cẩn thận.",approx:"IPA (Mỹ): /dɪˈmænd/ | gần đúng: di-MAND — IPA (Anh): /dɪˈmɑːnd/ | gần đúng: di-MAAND (nguyên âm dài và sâu hơn). Cả hai đều nhấn âm hai.",explain:"To ask for something forcefully, or to require it. It is much stronger than 'ask' or 'request', so using it with a colleague can sound rude. Two grammar points: in formal English it takes the subjunctive — 'They demanded that he leave', with the bare verb and no -s; and 'demand to do' is used when you insist on doing something yourself ('She demanded to see the manager'). As a noun it is the economics half of 'supply and demand' (cung và cầu). The adjective 'demanding' describes work or people that require a lot: 'a demanding boss'.",usage:"Native use: standard in news about protests and negotiations; 'in high demand' and 'demanding' are common at work.",visual:"📈"},
  {lesson:"Lesson 20",topic:"Everyday Nouns and Adjectives",english:"decision",vi:"quyết định; (decisive) quyết đoán hoặc mang tính quyết định",example:"It was the hardest decision of her whole career.",exampleVi:"Đó là quyết định khó khăn nhất trong cả sự nghiệp của cô ấy.",approx:"IPA: /dɪˈsɪʒən/ | gần đúng: di-SI-zhən (âm giữa là /ʒ/ như trong 'measure', KHÔNG phải /ʃ/ như 'shoe') — động từ 'decide': /dɪˈsaɪd/ | gần đúng: di-SAID (nguyên âm nhảy từ /ɪ/ sang /aɪ/)",explain:"A choice you have made after thinking. The collocation trap is the important part: in English you MAKE a decision — never 'do a decision'. British formal English also allows 'take a decision'. Other patterns: come to or reach a decision, a decision to do something, a decision on something. The adjective 'decisive' has two senses that both appear often: a decisive person is quick and firm (quyết đoán), while a decisive moment or goal is the one that settles the outcome.",usage:"Native use: one of the highest-frequency abstract nouns in English, and 'make a decision' is a must-know collocation.",visual:"⚖️"},
  {lesson:"Lesson 20",topic:"Everyday Nouns and Adjectives",english:"goal",vi:"mục tiêu, đích nhắm tới; bàn thắng (bóng đá); khung thành",example:"Her goal is to speak English fluently within a year.",exampleVi:"Mục tiêu của cô ấy là nói tiếng Anh trôi chảy trong vòng một năm.",approx:"IPA: /ɡoʊl/ | gần đúng: GOHL (G cứng như 'go', nguyên âm đôi /oʊ/ — đừng rút gọn thành 'gôn')",explain:"Something you are trying to achieve. Collocations you should use rather than translate: set a goal, achieve or reach a goal, work towards a goal, a short-term or long-term goal. Distinguish three near-synonyms: a 'goal' is specific and measurable, an 'aim' is a general intention, and an 'objective' is the formal wording used in business plans. The sports sense is fully alive: score a goal, the goalkeeper, a goalpost.",usage:"Native use: central to study plans, job interviews and self-improvement talk, plus every football commentary.",visual:"🎯"},
  {lesson:"Lesson 20",topic:"Everyday Nouns and Adjectives",english:"similar",vi:"tương tự, giống nhau nhưng không hoàn toàn",example:"Her jacket is similar to mine but a shade darker.",exampleVi:"Áo khoác của cô ấy tương tự áo của tôi nhưng đậm màu hơn một chút.",approx:"IPA: /ˈsɪmələr/ | gần đúng: SI-mə-lər — BA âm tiết, nhấn âm ĐẦU; rất nhiều người học đọc nhầm thành 'si-MI-lar'",explain:"Alike in some ways but not identical. The preposition is fixed: 'similar TO', never 'similar with' or 'similar than'. Learn the set together: the same AS, similar TO, different FROM. The noun is 'similarity' (with the stress moving to the third syllable: si-mi-LA-ri-ty), and the adverb 'similarly' is a useful linking word in writing when your second example matches the first. Remember that 'similar' is weaker than 'identical' (giống hệt).",usage:"Native use: extremely frequent in comparison, description and shopping; 'similarly' is a standard essay linker.",visual:"🔁"},
  {lesson:"Lesson 20",topic:"Everyday Nouns and Adjectives",english:"advanced",vi:"nâng cao, trình độ cao (lớp học); tiên tiến, hiện đại (công nghệ); (bệnh, tuổi) ở giai đoạn muộn, nặng",example:"She moved up to the advanced class after only one term.",exampleVi:"Cô ấy được lên lớp nâng cao chỉ sau một học kỳ.",approx:"IPA: /ədˈvænst/ | gần đúng: əd-VANST (nhấn âm hai; đuôi -ced đọc gọn là /st/, không thêm âm tiết)",explain:"At a high level of skill or development. The course ladder is fixed vocabulary: beginner, elementary, intermediate, upper-intermediate, advanced. For technology it means modern and highly developed — compare 'cutting-edge' from Lesson 18, which is stronger. The medical sense is important and can surprise learners: 'advanced cancer' means a late, serious stage. Keep it apart from the related but different 'in advance', meaning beforehand ('Pay in advance', 'Book two weeks in advance'), and 'an advance', a payment made early.",usage:"Native use: standard in education and technology; 'in advance' is one of the most common travel and payment phrases.",visual:"🎓"},
  {lesson:"Lesson 20",topic:"Everyday Nouns and Adjectives",english:"optional",vi:"tùy chọn, không bắt buộc",example:"The evening trip is optional, so you can stay at the hotel if you prefer.",exampleVi:"Chuyến đi buổi tối là tùy chọn, nên bạn có thể ở lại khách sạn nếu muốn.",approx:"IPA (Mỹ): /ˈɑːpʃənəl/ | gần đúng: OP-shə-nəl (nhấn âm đầu, ba âm tiết)",explain:"Something you may choose but do not have to do. Learn it against its opposites, which appear on the same forms: compulsory (British), mandatory (formal and legal), and required. You meet it constantly in writing: '(Optional)' beside a field on a form, 'optional extras' on a car or a tour, and 'an optional module' at university. The noun is 'option', and two idioms are very common: 'to keep your options open' (để ngỏ các lựa chọn) and 'I had no option but to...' (tôi không còn lựa chọn nào khác ngoài việc...).",usage:"Native use: everywhere on forms, in course descriptions and in travel bookings.",visual:"☑️"},
  {lesson:"Lesson 20",topic:"Linking Time",english:"since then",vi:"kể từ đó (cho đến nay)",example:"He moved to Da Nang in 2019 and has lived there ever since then.",exampleVi:"Anh ấy chuyển đến Đà Nẵng năm 2019 và đã sống ở đó kể từ đó đến giờ.",approx:"IPA: /sɪns ˈðen/ | gần đúng: sins-THEN (âm 'th' rung như trong 'this', không đọc thành 'sen'; trọng âm rơi vào 'then')",explain:"From a specific moment in the past up to now. Because the situation continues into the present, it normally goes with the present perfect: 'She started running in March and has not missed a day since then.' Close neighbours: 'ever since' is more emphatic, and 'from then on' means from that point forward, often used with past tenses in a story. Do not confuse it with plain 'then', which means either 'at that time' or 'next'.",usage:"Native use: the standard way to close a story about a change that is still true today.",visual:"⏳"},
  {lesson:"Lesson 20",topic:"Linking Time",english:"meanwhile",vi:"trong lúc đó, cùng lúc ấy; (chuyển ý trong bài viết) trong khi đó, mặt khác",example:"I will start the rice. Meanwhile, you can chop the vegetables.",exampleVi:"Tôi sẽ bắt đầu nấu cơm. Trong lúc đó, bạn có thể cắt rau.",approx:"IPA: /ˈmiːnwaɪl/ | gần đúng: MEEN-wail (nhấn âm đầu, hai âm tiết rõ ràng)",explain:"At the same time as something else that is happening. The grammar point matters: 'meanwhile' is an adverb, so it joins two separate sentences and takes a comma — 'I cooked. Meanwhile, she cleaned.' It is not a conjunction like 'while', which joins clauses inside one sentence: 'While I cooked, she cleaned.' In news writing it also switches you to a parallel story: 'Meanwhile, in the north, prices were falling.' 'In the meantime' means the same in the sense of during a waiting period.",usage:"Native use: a standard linker in journalism, recipes and any account of two things happening at once.",visual:"⏱️"},
  {lesson:"Lesson 20",topic:"Linking Time",english:"over time",vi:"theo thời gian, dần dần qua thời gian",example:"Over time, her pronunciation improved without her even noticing.",exampleVi:"Theo thời gian, phát âm của cô ấy tiến bộ mà chính cô cũng không nhận ra.",approx:"IPA: /ˌoʊvər ˈtaɪm/ | gần đúng: oh-vər-TAIM — viết RỜI hai chữ, trọng âm ở 'TIME'. Đừng nhầm với 'overtime' /ˈoʊvərtaɪm/ (OH-vər-taim) nghĩa là làm thêm giờ.",explain:"Gradually, across a long period. It is the natural phrase for describing slow change and usually sits at the front of the sentence with a comma, or at the end. The spelling trap is the thing to remember: written as one word, 'overtime' means extra hours at work ('He worked overtime all week') or extra time in a match. Near equivalents: gradually, little by little, as time went on, in the course of time.",usage:"Native use: very common in writing about habits, health, learning and long-term trends.",visual:"📅"},
  {lesson:"Lesson 20",topic:"Linking Time",english:"soon after",vi:"không lâu sau đó, ít lâu sau",example:"She sent the application on Monday and got a reply soon after.",exampleVi:"Cô ấy gửi hồ sơ vào thứ Hai và nhận được hồi âm không lâu sau đó.",approx:"IPA: /ˌsuːn ˈæftər/ | gần đúng: soon-AF-tər (trọng âm chính ở 'AF')",explain:"A short time later. It is flexible: it can stand alone at the end of a sentence ('...and he left soon after'), take a noun ('soon after the meeting'), or take a whole clause ('soon after he arrived'). Learn the family by degree of distance: 'straight after' or 'right after' means immediately, 'soon after' and 'shortly after' mean a short time later, and 'not long after' is the same idea in more casual speech. 'Afterwards' works alone but does not take an object.",usage:"Native use: the natural narrative linker in stories, reports and biographies.",visual:"➡️"},
  {lesson:"Lesson 20",topic:"Linking Time",english:"in the long run",vi:"về lâu dài, xét về lâu về dài",example:"Buying good shoes is cheaper in the long run.",exampleVi:"Mua giày tốt thì rẻ hơn về lâu dài.",approx:"IPA: /ɪn ðə ˌlɔːŋ ˈrʌn/ | gần đúng: in-thə-long-RUN (trọng âm rơi vào 'RUN'; 'the' đọc lướt là /ðə/)",explain:"Considering a long period in the future, almost always contrasting with a short-term cost or effort. It is a fixed phrase: keep 'the' and never say 'in long run' or 'in the long time'. The opposites are 'in the short run' and 'in the short term'. A close cousin, 'in the long term', is slightly more formal and more common in written analysis. This is one of the most useful phrases for essays and interviews: 'In the long run, the policy would save the city money.'",usage:"Native use: standard in argument, financial advice and IELTS Writing Task 2.",visual:"🛣️"}
];

grammarNotesBank["Lesson 20"] = [
  {title:"suggest, demand and the patterns they insist on",body:"Two verbs in this lesson refuse the pattern Vietnamese speakers expect. 'Suggest' never takes an object plus a to-infinitive: say 'I suggest going', 'I suggest that you go', or 'I suggest you go' — never 'I suggest you to go'. 'Recommend' behaves the same way. 'Demand' takes the subjunctive in formal English, which means the bare verb with no -s and no tense: 'They demanded that he leave the building.' If you want to insist on doing something yourself, use 'demand to do': 'She demanded to see the manager.'",pattern:"suggest + V-ing | suggest (that) + S + V | demand that + S + bare verb | demand to + V",example:"I suggest that we wait, but the residents demanded that the company reply within a week.",meaning:"Tôi đề xuất chúng ta chờ, nhưng người dân yêu cầu công ty phải trả lời trong vòng một tuần."},
  {title:"Where each time linker sits in the sentence",body:"These four linkers are not interchangeable in position. 'Since then' goes at the end and pulls the present perfect with it, because the situation continues. 'Meanwhile' is an adverb, so it opens a new sentence after a full stop and takes a comma — unlike 'while', which is a conjunction joining two clauses inside one sentence. 'Over time' and 'In the long run' usually open the sentence with a comma, and both can also go at the end. 'Soon after' can stand alone or take an object or clause.",pattern:"... since then + present perfect | Sentence. Meanwhile, sentence. | While + clause, clause. | Over time, ... | In the long run, ... | ... soon after (the meeting / he arrived)",example:"She registered for the course in March and has studied every evening since then. Meanwhile, her brother did nothing, and over time the gap between them grew.",meaning:"Cô ấy đăng ký khóa học vào tháng Ba và kể từ đó đã học mỗi tối. Trong khi đó, anh trai cô chẳng làm gì cả, và theo thời gian khoảng cách giữa hai người ngày càng lớn."},
  {title:"-ed or -ing? Describing a state versus a process",body:"The skin words in this lesson split into two grammatical groups, and choosing the wrong one changes the meaning. Past participles used as adjectives — chapped, cracked, wrinkled, calloused — describe a state that already exists: 'My lips are chapped.' The -ing forms — peeling, flaking — describe a process that is happening now: 'My back is peeling.' Notice that 'peel' takes an object when you do it to food ('Peel the potatoes') but takes no object when skin or paint does it by itself.",pattern:"be + chapped / cracked / wrinkled / calloused (state) | be + peeling / flaking (process) | peel sth (transitive) vs sth peels (intransitive)",example:"His heels are cracked and his hands are calloused, and after the sunburn his shoulders are still peeling.",meaning:"Gót chân anh ấy nứt nẻ, bàn tay chai sạn, và sau đợt cháy nắng thì vai vẫn còn đang bong da."},
  {title:"Stress, silent letters and lookalike spellings",body:"'Produce' shifts stress like 'refund' (Lesson 17) and 'upgrade' (Lesson 18), but here the meaning changes completely: proDUCE is the verb, PROduce is fruit and vegetables. 'Consume' is /kənˈsuːm/ but the noun 'consumption' switches the vowel to /ʌ/. 'Decide' has /aɪ/ while 'decision' has /ɪ/ plus the soft /ʒ/ of 'measure'. 'Similar' is stressed on the first syllable, not the second. The 'w' in 'wrinkled' is silent. And two pairs are spelling traps: callus (the lump) versus callous (unfeeling), and 'over time' (gradually) versus 'overtime' (extra working hours).",pattern:"proDUCE (v) / PROduce (n) | conSUME / conSUMPtion | deCIDE / deCIsion | SIMilar | (w)rinkled | callus vs callous | over time vs overtime",example:"The farm produces excellent fresh produce, and the decision to sell it locally was made over time, not overtime.",meaning:"Nông trại sản xuất ra nông sản tươi tuyệt vời, và quyết định bán tại địa phương được hình thành dần theo thời gian, chứ không phải trong lúc làm thêm giờ."}
];

grammarBank["Lesson 20"] = [
  {q:"Choose the correct sentence:",choices:["I suggest that you take the earlier train.","I suggest you to take the earlier train.","I suggest to you taking the earlier train."],a:"I suggest that you take the earlier train.",why:"'Suggest' never takes an object plus a to-infinitive; use 'suggest that + subject + verb' or 'suggest + V-ing'."},
  {q:"Choose the correct preposition: Her jacket is similar ___ mine but a shade darker.",choices:["to","with","than"],a:"to",why:"The fixed set is: the same AS, similar TO, different FROM."},
  {q:"Choose the correct collocation: It took her a week to ___ a decision.",choices:["make","do","get"],a:"make",why:"You make a decision in English; British formal writing also allows 'take a decision', but never 'do a decision'."},
  {q:"Choose the correct linker: I will start the rice. ___, you can chop the vegetables.",choices:["Meanwhile","While","Since then"],a:"Meanwhile",why:"'Meanwhile' is an adverb that opens a new sentence; 'while' is a conjunction that must join two clauses inside one sentence."}
];

listeningBank["Lesson 20"] = {
  text:"Two winters ago Trang registered for an evening course in industrial design, mostly because a colleague had suggested it over lunch and she could not think of a good reason to say no. The first thing she noticed was not the work but her hands. The studio was cold, the sinks ran icy water, and within a fortnight her lips were chapped, the skin around her knuckles was dry and flaky, and a small callus had formed on her middle finger from holding a pencil for six hours a week. Her tutor laughed and said that every designer in the room had the same one. The course itself was harder than the brochure suggested. It was described as advanced, and the reading was genuinely demanding: three long articles a week, all of which consumed her Sunday evenings. Only the final project was optional, and almost nobody skipped it. Trang made a decision early on that she would finish whatever happened, and she wrote her goal on a card above her desk: to design one product properly, from the first sketch to a working model. Meanwhile, her job carried on as normal, and for months she was too tired to notice any progress. Over time, though, the change was obvious to everyone but her. Her drawings became cleaner. She stopped copying other people's shapes and started producing her own. Soon after the course ended, her manager asked her to lead a small redesign project, and she said yes before he had finished the sentence. Since then she has led four more. She still keeps the card above her desk, next to a photograph of her first model, and when younger colleagues ask whether an evening course is worth the exhaustion, she gives the same answer every time: it is expensive and it eats your weekends, but in the long run it pays for itself many times over.",
  meaning:"Hai mùa đông trước, Trang đăng ký một khóa học buổi tối về thiết kế công nghiệp, phần lớn vì một đồng nghiệp đã gợi ý trong bữa trưa và cô không nghĩ ra lý do nào hay ho để từ chối. Điều đầu tiên cô nhận thấy không phải là bài vở mà là đôi tay mình. Xưởng học thì lạnh, vòi nước thì buốt, và chỉ trong hai tuần môi cô đã nứt nẻ, vùng da quanh các khớp ngón tay khô và bong vảy, còn một vết chai nhỏ đã hình thành trên ngón giữa vì cầm bút chì sáu tiếng mỗi tuần. Thầy hướng dẫn của cô bật cười và nói rằng mọi nhà thiết kế trong phòng đều có đúng vết chai đó. Bản thân khóa học khó hơn những gì tờ rơi gợi ý. Nó được mô tả là trình độ nâng cao, và phần đọc thì đòi hỏi thực sự: ba bài viết dài mỗi tuần, tất cả đều ngốn hết các tối Chủ nhật của cô. Chỉ có đồ án cuối kỳ là tùy chọn, mà gần như chẳng ai bỏ qua. Trang đã đưa ra quyết định ngay từ sớm rằng cô sẽ học đến cùng dù có chuyện gì xảy ra, và cô viết mục tiêu của mình lên một tấm thẻ dán phía trên bàn: thiết kế trọn vẹn một sản phẩm, từ bản phác đầu tiên đến một mô hình chạy được. Trong lúc đó, công việc của cô vẫn diễn ra như thường, và suốt nhiều tháng cô mệt đến mức không nhận ra tiến bộ nào. Tuy nhiên, theo thời gian, sự thay đổi trở nên rõ ràng với tất cả mọi người trừ chính cô. Các bản vẽ của cô sạch sẽ hơn. Cô thôi sao chép hình khối của người khác và bắt đầu tạo ra hình khối của riêng mình. Không lâu sau khi khóa học kết thúc, quản lý đề nghị cô dẫn dắt một dự án thiết kế lại quy mô nhỏ, và cô đồng ý trước cả khi anh ấy nói hết câu. Kể từ đó cô đã dẫn dắt thêm bốn dự án nữa. Cô vẫn giữ tấm thẻ phía trên bàn làm việc, ngay cạnh bức ảnh chụp mô hình đầu tiên, và khi các đồng nghiệp trẻ hỏi liệu một khóa học buổi tối có đáng với sự kiệt sức hay không, cô luôn đưa ra cùng một câu trả lời: nó đắt đỏ và nó ngốn hết cuối tuần của bạn, nhưng về lâu dài nó sinh lời gấp nhiều lần.",
  questions:[
    {q:"What three things happened to Trang's skin during the first fortnight of the course?",a:["her lips were chapped, the skin around her knuckles was flaky, and she got a callus","chapped lips, dry flaky skin around her knuckles, and a callus on her middle finger"],hint:"One about the lips, one about dry skin coming off, one about a hard patch from a pencil."},
    {q:"Which part of the course was optional?",a:["the final project","only the final project"],hint:"Almost nobody skipped it anyway."},
    {q:"What answer does Trang give when younger colleagues ask if an evening course is worth it?",a:["that in the long run it pays for itself many times over","it is expensive and eats your weekends, but in the long run it pays for itself"],hint:"She admits the short-term cost, then uses a four-word time phrase from this lesson."}
  ],
  dictation:["Over time the change was obvious to everyone but her, and soon after the course ended her manager asked her to lead a project.","It is expensive and it eats your weekends, but in the long run it pays for itself many times over."]
};

quizBank["Lesson 20"] = [
  {q:"Translate: nứt nẻ, khô nẻ (môi vì lạnh và gió)",a:["chapped"],hint:"One syllable; the -ed is pronounced /t/."},
  {q:"Complete: The skin around his nose is dry and ___ in cold weather.",a:["flaky"],hint:"Coming off in small thin pieces; in baking the same word is praise."},
  {q:"Complete: After a summer in sandals her heels were badly ___.",a:["cracked"],hint:"Stronger than chapped — the skin has actually split open."},
  {q:"Complete: My hand started ___ a week after the sunburn.",a:["peeling"],hint:"Coming away from the surface in thin layers, with no object."},
  {q:"Translate: vết chai, cục da chai sần ở chân hoặc tay",a:["callus"],hint:"Spelled with -us; the adjective spelled -ous means cruel."},
  {q:"Complete: You have to ___ for the exam before the end of the month.",a:["register"],hint:"Put your name on an official list."},
  {q:"Complete: I ___ that we leave an hour earlier to avoid the traffic.",a:["suggest"],hint:"Never followed by an object plus 'to do'."},
  {q:"Complete: The factory ___ two thousand bottles an hour.",a:["produces"],hint:"The verb is stressed on the second syllable."},
  {q:"Complete: Older air conditioners ___ far more electricity than new ones.",a:["consume"],hint:"To use up a resource; the formal word for eating and drinking too."},
  {q:"Complete: The job ___ a lot of patience and very careful attention.",a:["demands"],hint:"Much stronger than 'ask'; as a noun it pairs with 'supply'."},
  {q:"Complete: It was the hardest ___ of her whole career.",a:["decision"],hint:"You MAKE this, never 'do' it."},
  {q:"Complete: Her ___ is to speak English fluently within a year.",a:["goal"],hint:"Specific and measurable; also what you score in football."},
  {q:"Complete: Her jacket is ___ to mine but a shade darker.",a:["similar"],hint:"Three syllables, stress on the first, always followed by 'to'."},
  {q:"Complete: She moved up to the ___ class after only one term.",a:["advanced"],hint:"The level after upper-intermediate."},
  {q:"Complete: The evening trip is ___, so you can stay at the hotel.",a:["optional"],hint:"The opposite of compulsory or mandatory."},
  {q:"Translate: kể từ đó (cho đến nay)",a:["since then"],hint:"Two words; it pulls the present perfect with it."},
  {q:"Complete: I will start the rice. ___, you can chop the vegetables.",a:["meanwhile"],hint:"An adverb that opens a new sentence, not a conjunction."},
  {q:"Translate: theo thời gian, dần dần qua thời gian",a:["over time"],hint:"Two separate words — one word means extra hours at work."},
  {q:"Complete: She sent the application on Monday and got a reply ___ ___.",a:["soon after"],hint:"A short time later; it can stand alone at the end of a sentence."},
  {q:"Translate: về lâu dài, xét về lâu về dài",a:["in the long run"],hint:"Four words; keep 'the'. The opposite is 'in the short term'."},
  {q:"Complete: The supermarket's fresh ___ section is by the entrance.",a:["produce"],hint:"The noun sense, stressed on the FIRST syllable: fruit and vegetables."},
  {q:"Complete: His name simply did not ___ — I had no idea who she was talking about.",a:["register"],hint:"The 'it did not reach my brain' sense."},
  {q:"Complete: The evidence ___ that the two events are connected.",a:["suggests"],hint:"The academic sense: to indicate without proving."},
  {q:"Complete: Filling in the form by hand was extremely time-___.",a:["consuming"],hint:"The compound adjective built on a verb from this lesson."},
  {q:"Complete: My new manager is very ___ — she expects a report every single morning.",a:["demanding"],hint:"The adjective describing work or people that require a lot."},
  {q:"Complete: We booked the tickets two weeks ___ ___ to get a better price.",a:["in advance"],hint:"Beforehand — related to 'advanced' but a different phrase."},
  {q:"Complete: I had no ___ but to accept their offer.",a:["option"],hint:"The noun behind 'optional'."},
  {q:"Complete: It was a ___ remark, and nobody in the room laughed.",a:["callous"],hint:"Spelled with -ous: cruel and unfeeling. Same sound as the skin lump."},
  {q:"Complete: The goal that won the match in the last minute was ___.",a:["decisive"],hint:"The adjective meaning 'settling the outcome' — also means quick and firm about people."},
  {q:"Complete: He worked ___ every evening last week and was paid extra for it.",a:["overtime"],hint:"One word: extra working hours, not the 'gradually' phrase."},
  {q:"Complete: His voice ___ when he tried to finish the sentence.",a:["cracked"],hint:"The emotional sense: the voice broke and lost control."},
  {q:"Complete: She is so ___ — she agrees to meet and then cancels an hour before.",a:["flaky"],hint:"The informal 'unreliable person' sense of a skin word."}
];
...
const lessonCatalog = [
  ...
  createLesson("Lesson 18", lesson18Items),
  createLesson("Lesson 19", lesson19Items),
  createLesson("Lesson 20", lesson20Items)
];
